...
<form id="form1" >
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        ...
        <input type="hidden" name = "combLevel" value="${combLevel}"/>
        <tr>
            <td align="right">
                所属月份：
            </td>
            <td>
                ...
                <input name="planMonth" type="hidden" id="planMonth" value="${planMonth}"
            ...
            <td>
                ...
                <input type="radio" id="type2" name="planadjUnifiedType" value="2" checked="checked"/>
                        ...
                        <td>
                            ...
                            <c:if test="${!empty creditPlanList[adj_key]}">
                                <input name="${organ.thiscode}_${comb.combcode}_init"    oninput='upperCase(this)' value="${creditPlanList[adj_key]}" type="hidden"
                                       class = "${organ.thiscode}_init ${comb.combcode}_init init" />
                                <span name="${organ.thiscode}_${comb.combcode}_init"  ><fm:formatNumber maxFractionDigits="10" value="${creditPlanList[adj_key]}"/></span>
                            </c:if>
                        </td>
                        <td>
                            ...
                            <c:if test="${!empty reqList[adj_key]}">
                                <input name="${organ.thiscode}_${comb.combcode}_req"  oninput='upperCase(this)' value="${reqList[adj_key]}" type="hidden"
                                       class = "${organ.thiscode}_req ${comb.combcode}_req req"/>
                                <span name="${organ.thiscode}_${comb.combcode}_req"><fm:formatNumber maxFractionDigits="10" value="${reqList[adj_key]}"/></span>
                            </c:if>
                        </td>
                        <td>
...
<script>
 ...
 function transFormat(amount) {
    ...
    function submitPlanadj() {
        //信贷调整详情url
        var adjustUrl = "<%=path%>/tbPlanadj/savePlanadj.htm";
