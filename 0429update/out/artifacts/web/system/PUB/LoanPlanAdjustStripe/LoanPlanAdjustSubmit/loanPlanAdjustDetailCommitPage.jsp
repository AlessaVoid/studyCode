    ...
    <tr>
        <td colspan="8">
            <div align="center">
                ...
                ><span>提交</span></button>
                <button id="cancelSubmitInfo" type="button" onclick="return cancel()" class="rejectButton"/>
            </div>
        </td>
    </tr>
</table>
...
<script type="text/javascript">
    ...
    function submitInfo() {
        ...
        top.Dialog.confirm("确定要提交审批吗？", function () {
            ...
            $.ajax({
                url: '<%=path%>/tbPlanadjStripeApp/startLoanPlanadjAudit.htm',
                type: 'GET',
                data: {
                    "auditOper": auditOper,
                    "comment": comment,
 ...
 if(menu_id==undefined){
    ...
    function initAuditOper() {
        //初始化计划审批人员
        $.ajax({
            url: "<%=path%>/tbPlanadjStripeApp/getOperInfoListByRolecode.htm?rolecode=${rolecode}",
            method: "GET",
            async: false,
