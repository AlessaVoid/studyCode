...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/lineOverApplyPendingApp/getPendingAppTbLineOver.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/lineOverApplyPendingApp/tbQuotaApplyAuditUI.htm?qaid=" + rows[0].qaid + "&taskid=" + rows[0].taskid , "审批单一条线计划调整申请", 1280, 680);
        } else {
