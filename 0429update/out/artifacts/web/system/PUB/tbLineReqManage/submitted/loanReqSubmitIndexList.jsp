...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbLineReqSub/getSubmitAuditHistoryRecord.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/TbLineReqSub/listReqSubmitDetailAuditUI.htm?lineReqId=" + rows[0].linereqid + "&processInstanceId=" + rows[0].procinstid, "信贷详细信息", 1280, 680);
        }
    }
