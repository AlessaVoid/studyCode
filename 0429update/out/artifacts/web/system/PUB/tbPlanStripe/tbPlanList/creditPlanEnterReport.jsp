...
<head>
    ...
    <script type="text/javascript">
        ...
        function xhrSubmit() {
            ...
            top.Dialog.confirm("确定要录入该计划吗?|操作提示", function() {
                ...
                $.ajax({
                    url: '<%=path%>/creditPlanStripe/enterReportPlanByMonth.htm',
                    type: 'POST',
                    data: fd,
 ...
 if(menu_id==undefined){
        ...
        function planMonthChange(){
            ...
            $.ajax({
                type: "get",
                url: "<%=path%>/creditPlanStripe/creditPlanEnterJudgeMonth.htm",
...
<div class="form-group">
    <label class="col-sm-2 control-label">录入条线模板下载：</label>
    <a href="<%=path%>/creditPlan/downloadPlanTemplate.htm?type=2">
