...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbReqresetSub/getSubmitAuditHistoryRecord.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/TbReqresetSub/listReqSubmitDetailAuditUI.htm?reqresetId=" + rows[0].reqresetid + "&processInstanceId=" + rows[0].procinstid, "信贷详细信息", 1280, 680);
        }
    }
