...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbReqresetApproved/getApprovedAuditHistoryRecord.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/TbReqresetApproved/listReqApprovedDetailAuditUI.htm?reqresetId=" + rows[0].reqresetid + "&processInstanceId=" + rows[0].procinstid, "需求调整详细信息", 1280, 680);
        }
    }
