...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/TbQuotaApplyPendingApp/getPendingAppTbQuotaApply.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/TbQuotaApplyPendingApp/tbQuotaApplyAuditUI.htm?qaid=" + rows[0].qaid + "&taskid=" + rows[0].taskid , "审批单一机构临时额度申请", 1280, 680);
        } else {
