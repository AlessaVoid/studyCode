...
<script type="text/javascript">
    ...
    var oldMonth = "${TbReqListDTO.reqMonth}";
    ...
    function submitInfo() {
        ...
        if (reqDateEnd - reqTimeEnd > 0) {
            top.Dialog.alert("需求录入结束日期应小于等于周期结束日期", null, null, null, 5);
            return
        }
        if (reqNote == "") {
        ...
        $.post('<%=path%>/tbTradeManger/tbReqList/update.htm',
            {
                'reqMonth': reqMonth,
                'oldMonth': oldMonth,
                'reqId': reqId,
    ...
    function transDate() {
        var reqMonth = $("#reqMonth").val();
        if (reqMonth == null || reqMonth == undefined) {
            reqMonth = "${TbReqListDTO.reqMonth}";
        }

        if ("请选择" == reqMonth || "" == reqMonth) {
            // $("#reqTimeStart").val("");
            // $("#reqTimeEnd").val("");
            document.getElementById("reqMonth").disabled = true;
            $("#reqMonth").setValue("");
    ...
    function initComplete() {
        ...
        $("#reqMonth").setValue("${TbReqListDTO.reqMonth}");
...
<form id="form1">
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        <tr>
            ...
            <td>
                <input type="text" id="reqName" name="reqName" maxlength="30" AUTOCOMPLETE="off"
                       value="${TbReqListDTO.reqName}"/>
        ...
        <tr>
            ...
            <td><input type="hidden" id="reqId" name="reqId" value="${TbReqListDTO.reqId}"/>
                <select id="reqMonth" name="reqMonth" onchange="transDate()" value="${TbReqListDTO.reqMonth}"></select>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="reqTimeStart" name="reqTimeStart" class="validate[required] date"
                       ...
                       value="${TbReqListDTO.reqTimeStart}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <input type="text" id="reqTimeEnd" name="reqTimeEnd" class="validate[required] date" AUTOCOMPLETE="off"
                       ...
                       value="${TbReqListDTO.reqTimeEnd}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="expTimeStart" name="expTimeStart" class="validate[required] date"
                       AUTOCOMPLETE="off" onchange="trandDateTime()"
                       value="${TbReqListDTO.expTimeStart}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <input type="text" id="expTimeEnd" name="expTimeEnd" class="validate[required] date" AUTOCOMPLETE="off"
                       onchange="trandDateTime()"
                       value="${TbReqListDTO.expTimeEnd}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="rateTimeStart" name="rateTimeStart" class="validate[required] date"
                       AUTOCOMPLETE="off" onchange="trandDateTime()"
                       value="${TbReqListDTO.rateTimeStart}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <input type="text" id="rateTimeEnd" name="rateTimeEnd" class="validate[required] date" AUTOCOMPLETE="off"
                       onchange="trandDateTime()"
                       value="${TbReqListDTO.rateTimeEnd}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="balanceTimeStart" name="balanceTimeStart" class="validate[required] date"
                       AUTOCOMPLETE="off" onchange="trandDateTime()"
                       value="${TbReqListDTO.balanceTimeStart}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <input type="text" id="balanceTimeEnd" name="balanceTimeEnd" class="validate[required] date" AUTOCOMPLETE="off"
                       onchange="trandDateTime()"
                       value="${TbReqListDTO.balanceTimeEnd}" dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="reqDateStart" name="reqDateStart" class="validate[required] date"
                       AUTOCOMPLETE="off"
                       value="${TbReqListDTO.reqDateStart}" onfocus="WdatePicker({skin:themeColor,minDate:'%y-%M-%d'})"
                       dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <input type="text" id="reqDateEnd" name="reqDateEnd" class="validate[required] date" AUTOCOMPLETE="off"
                       value="${TbReqListDTO.reqDateEnd}" onfocus="WdatePicker({skin:themeColor,minDate:'%y-%M-%d'})"
                       dateFmt="yyyyMMdd"/>
                <span class="star">*</span>
            </td>
        </tr>
        ...
        <tr id="tr_1">
            ...
            <td>
                <div id="reqCombList" selectedValue="${TbReqListDTO.reqCombList}"
            ...
            <td>
                <div id="reqOrganList"
                     selectedValue="${TbReqListDTO.reqOrganList}"
        ...
        <tr id="tr_2">
            ...
            <td>
                ...
                <div id="reqProdLine" selectedValue="${TbReqListDTO.reqProdLine}"
        ...
        <tr>
            ...
            <td>
                <div id="numType" selectedValue="${TbReqListDTO.numType}"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea id="reqNote" name="reqNote" AUTOCOMPLETE="off"
