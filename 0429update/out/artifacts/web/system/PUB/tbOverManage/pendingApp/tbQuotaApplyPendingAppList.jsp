    ...
    <form action="" id="queryForm" method="post">
        <table class="tableStyle" mode="list" formMode="line" style="width: 100%;">
            <tr>
                ...
                <td>机构名称：</td>
                <td width="20">
                    <input type="text" id="organname" name="organname" matchName="organname"></input>
                </td>
                <td>
                    <div align="center">
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/overApplyPendingApp/getPendingAppTbOver.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/overApplyPendingApp/tbQuotaApplyAuditUI.htm?qaid=" + rows[0].qaid + "&taskid=" + rows[0].taskid, "审批单一机构计划调整申请", 1280, 680);
        } else {
