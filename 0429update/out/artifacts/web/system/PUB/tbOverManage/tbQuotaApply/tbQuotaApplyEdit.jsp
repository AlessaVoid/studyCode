...
<script type="text/javascript">
    ...
    function submitInfo() {
        ...
        $.ajax({
            url: '<%=path%>/tbTradeManger/over/update.htm',
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
...
<form id="form2">
    <table class="tableStyle" id="table1" width="80%" mode="list" formMode="line">
        ...
        <tr>
            ...
            <td>
                <dic:select id="unit" dicType="CURRENCY_UNIT" name="unit" dicNo="${TbOver.unit}"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea id="qaReason" name="qaReason" AUTOCOMPLETE="off"   style="width:90%;" class="validate[required]">${TbOver.qaReason}</textarea>
            </td>
        </tr>
    </table>
</form>
