...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/tbOrganRateScoreMonthPendingApp/getPendingAppRateScore.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/tbOrganRateScoreMonthPendingApp/listRateScoreDetailAuditUI.htm?id=" + rows[0].id + "&taskid=" + rows[0].taskid, "审批评分", 1600, 800);
        } else {
