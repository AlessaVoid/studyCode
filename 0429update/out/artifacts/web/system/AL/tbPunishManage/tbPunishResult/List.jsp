    ...
    <form action="" id="queryForm" method="post">
        <table class="tableStyle" mode="list" formMode="line" style="width: 100%;">
            <tr>
                <td>所属月份：</td>
                <td width="20">
                    <input name="punishMonth" type="text" id="sys_time" class="input-small inline form_datetime"
                           style="width: 160px;"/>
                </td>
                <td>
                    <div align="center">
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/tbTradeManger/tbPunishResult/findPage.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onSubmit() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/tbTradeManger/tbPunishResult/commitUI.htm?punishId=" + rows[0].punishId,
                "反馈意见", 1000, 480);
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            var rows = grid.getSelectedRows();
            showDialog("<%=path%>/tbTradeManger/tbPunishResult/infoUI.htm?punishId=" + rows[0].punishId,
                "详细信息", 1000, 480);
        }
    }
