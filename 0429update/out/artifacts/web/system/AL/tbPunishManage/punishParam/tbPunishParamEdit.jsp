...
<script type="text/javascript">
    function submitInfo() {
        ...
        $.post('<%=path%>/punishManger/punishParam/update.htm',
        ...
        <tr>
            ...
            <td colspan="3">
                <dic:select id="type" dicType="PENALTY_TIME_TYPE" name="type" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[0].type}" required="true"></dic:select>
            ...
            <td colspan="3">
                <dic:select id="state" dicType="PENALTY_STATE" name="state" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[0].state}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dic:select id="ppType1" dicType="PENALTY_TYPE" name="ppType1" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[0].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                收取类型：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType2" dicType="PENALTY_TYPE" name="ppType2" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[1].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype2" dicType="COLLECT_TYPE" name="collecttype2" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[1].collecttype}"     onchange="check(2);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType3" dicType="PENALTY_TYPE" name="ppType3" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[2].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype3" dicType="COLLECT_TYPE" name="collecttype3" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[2].collecttype}"    onchange="check(3);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType4" dicType="PENALTY_TYPE" name="ppType4" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[3].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype4" dicType="COLLECT_TYPE" name="collecttype4" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[3].collecttype}"   onchange="check(4);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType5" dicType="PENALTY_TYPE" name="ppType5" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[4].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype5" dicType="COLLECT_TYPE" name="collecttype5" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[4].collecttype}"  onchange="check(5);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType6" dicType="PENALTY_TYPE" name="ppType6" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[5].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype6" dicType="COLLECT_TYPE" name="collecttype6" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[5].collecttype}"  onchange="check(6);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType7" dicType="PENALTY_TYPE" name="ppType7" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[6].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype7" dicType="COLLECT_TYPE" name="collecttype7" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[6].collecttype}"    onchange="check(7);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
        ...
        <tr>
            ...
            <td>
                <dic:select id="ppType8" dicType="PENALTY_TYPE" name="ppType8" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[7].ppType}" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            ...
            <td>
                <dic:select id="collecttype8" dicType="COLLECT_TYPE" name="collecttype8" tgClass="validate[required]"
                            dicNo="${TbPunishParamDTOList[7].collecttype}"   onchange="check(8);" required="true"></dic:select>
                <span class="star">*</span>
            </td>
            <td align="right">
                最小值：
