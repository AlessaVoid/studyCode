...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/punishApplyApproved/getApprovedAuditHistoryRecord.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/punishApplyApproved/approvedDetailAuditUI.htm?id=" + rows[0].id + "&processInstanceId=" + rows[0].procinstid, "详细信息", 1780, 680);
        }
    }
