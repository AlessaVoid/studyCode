        ...
        <tr>
            <td colspan="8">
                <div align="center">
                    ...
                    ><span>提交</span></button>
                    <button id="cancelSubmitInfo" type="button" onclick="return cancel()" class="cancelButton"></button>
                </div>
            </td>
        </tr>
    </table>
...
<script>
 ...
 if(menu_id==undefined){
    ...
    $(function(){
        ...
        //判断页面是否有未提交
        $(".rateScore").change(function(){
            isSubmit = false;
        });
        $(".rateLevel").change(function(){
            isSubmit = false;
        });
    })
    ...
    function initAuditOper() {
        $.ajax({
                url: "<%=path%>/tbOrganRateScoreMonthReject/getOperInfoListByRolecode.htm?taskid=${taskid}",
                method: "GET",
                async: false,
    ...
    function submit(isAgree) {
        ...
        $.ajax({
            url: "<%=path%>/tbOrganRateScoreMonthReject/auditRateScoreRequest.htm",
            data: {
                "id": id,
                "taskId": taskId,
                "comment": comment,
