...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/tbOrganRateScoreQuarterLowOrgan/tbOrganRateScoreMonthData.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/tbOrganRateScoreQuarterLowOrgan/tbOrganRateScoreMonthDetailPage.htm?id=" + rows[0].id, "评分详情信息", 1800, 600);
        }
    }
