...
<div class="box2_custom" boxType="box2" panelTitle="数据列表" class="padding_right5">
    <div align="center" ><h3  style="display: inline;">行业表&nbsp;&nbsp;</h3></div>
    <div></div>
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/report/industryExcel.htm',
                    sortName: '',
                    // rownumbers: true,
    ...
    function onDownload() {
        ...
        location = "<%=path%>/report/downloadIndustryExcel.htm?date=" + date + "&cycel=" + cycel + "&unit=" + unit;
    }
