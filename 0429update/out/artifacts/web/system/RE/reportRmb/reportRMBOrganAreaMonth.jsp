...
<body>
    <div>
        <div class="divider">
            <div class="bigTitle">人民币贷款情况报表管理 - 机构、区域结构(月)报表</div>
                ...
                <thead>
                    <tr>
                        ...
                        <c:forEach items="${loanTypeList}" var="loanType">
                            <th align="center" style="width:2420px" colspan="22">${loanType.alias}</th>
                        </c:forEach>
                    </tr>
                    <tr>
                        <c:forEach items="${loanTypeList}" var="loanType" varStatus="status">
                            ...
                            <td style="width:100px" align="center">比月初</td>
                            ...
                            <td style="width:100px" align="center">排名</td>
                            <td style="width:100px" align="center">月计划完成率同比</td>
                            <td style="width:100px" align="center">月增速</td>
                            <td style="width:100px" align="center">排名</td>
                            <td style="width:100px" align="center">月增速同比</td>
                            <td style="width:100px" align="center" <c:if test="${status.last}">class="lastTd"</c:if>>月增速环比</td>
                        </c:forEach>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>合计</td>
                        <c:forEach var="i" begin="1" end="88">
                    ...
                    <c:forEach items="${organList}" var="organ">
                        <tr>
                            ...
                            <c:forEach var="i" begin="1" end="88" varStatus="status">
                                <td align="right">  </td>  <!-- TODO -->
                            </c:forEach>
                        </tr>
                    </c:forEach>
