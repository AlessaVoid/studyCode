		...
		<div name="发起确认请求" style="width:100%;height:300px;">
   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								${appDataMap.prodName}
								<input type="hidden" name="prodName" id="prodName" value="${appDataMap.prodName}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="hidden" name="prodStatus" id="prodStatus" value="${appDataMap.prodStatus}" />
								<dic:out dicType="PROD_STATUS" dicNo="${appDataMap.prodStatus}" ></dic:out>
							</td>
						</tr>
					<tr>
						<td colspan="2">
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/webGfProdStatus/doApproval.htm')" class="saveButton"/>
