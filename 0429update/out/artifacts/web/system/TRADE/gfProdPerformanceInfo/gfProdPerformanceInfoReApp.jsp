				...
				<div name="产品净值新增复核" style="width:100%;height:300px;">
	   				...
	   				<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="performanceDate" value="${appDataMap.performanceDate}" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="performanceUseDate" value="${appDataMap.performanceUseDate}" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="performanceValue" id="performanceValue" value="${appDataMap.performanceValue}" class="validate[required],money"/>%
							</td>
						</tr>
						<tr>
				            <td align="right">是否挂钩标的：</td>
				             <td>
						     <dic:select onChange="changeIsPeg(this.value);" name="isPeg" id="isPeg" dicType="IS_YES" dicNo="${entity.isPeg}" value=${appDataMap.isPeg }></dic:select>
						     </td>
						</tr>
						<tr>
						      <td>挂钩描述：</td>
