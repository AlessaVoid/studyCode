...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="暂停交易参数复核" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<dic:out dicType="D_CHNL" dicNo="${appDataMap.channelCode}" ></dic:out>
								<input type="hidden" name="channelCode" id="channelCode" value="${appDataMap.channelCode}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								${appDataMap.tradeCode}
								<input type="hidden" name="tradeCode" id="tradeCode" value="${appDataMap.tradeCode}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
							<dic:out dicType="USE_STATUS" dicNo="${appDataMap.status}"></dic:out>
				...
				<input type="hidden" name="operDescribe" value="${webReviewMain.operDescribe}"/>
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdTradeCtl/doApproval.htm')" class="saveButton"/>
