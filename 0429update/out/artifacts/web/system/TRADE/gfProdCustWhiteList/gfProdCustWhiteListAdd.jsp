...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="设置客户白名单" style="width:100%;height: 5px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" name="taCode" class="validate[required],custom[noSpecialCaracters]" maxlength="30"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
