		...
		<form id="form1">
    			<div name="删除信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<input type="hidden" name="taCode" value="${entity.taCode}" id="taCode"/>
						<input type="hidden" name="operDescribe" value="客户黑白名单管理" /> 
						<input type="hidden" name="tradeCode" value="TRADE-05-03" />
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdCustWhiteList/delete.htm')" class="saveButton"/>
