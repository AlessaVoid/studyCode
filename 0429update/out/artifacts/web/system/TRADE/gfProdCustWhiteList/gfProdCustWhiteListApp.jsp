	...
	<body>
		...
		<div class="basicTabModern">
				<div name="客户黑白名单复核" style="width:100%;height:300px;">
	   				<input type="hidden" name="taCode" value="${appDataMap.taCode}"/>
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								${appDataMap.taCode}
								<input type="hidden" name="acctCode" value="${appDataMap.taCode}" class="validate[required],custom[noSpecialCaracters]" maxlength="30"/>
							</td>
						</tr>
						<tr>
							<td align="right">
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdCustWhiteList/doApproval.htm')" class="saveButton"/>
