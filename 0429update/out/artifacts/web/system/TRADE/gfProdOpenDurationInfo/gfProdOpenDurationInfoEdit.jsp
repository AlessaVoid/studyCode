...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="修改" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						<tr>
							...
							<td>
							${entity.prodCode}<input type="hidden" name="prodCode" value="${entity.prodCode}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								${entity.beginDate}<input type="hidden" name="beginDate" value="${entity.beginDate}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
							${entity.endDate}<input type="hidden" name="endDate" id="endDate" value="${entity.endDate}"/>
						...
						<tr>
							...
							<td>
								<c:if test="${entity.paraType==1}">申购<input type="hidden" name="paraType" value="${entity.paraType}"/></c:if>
								<c:if test="${entity.paraType==2}">赎回<input type="hidden" name="paraType" value="${entity.paraType}"/></c:if>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" class="date" dateFmt="yyyyMMdd" name="quotAffirmDate" id="quotAffirmDate" value="${entity.quotAffirmDate}"/>
							</td>
						</tr>
						<tr>
							<td colspan="4">
								<div align="center">
 									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdOpenDurationInfo/update.htm')" class="saveButton"/>
