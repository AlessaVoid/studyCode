		...
		<div class="basicTabModern">
				<div name="客户黑白名单" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" name="organCode" value="${appDataMap.organCode}" class="validate[required],custom[noSpecialCaracters]" maxlength="8"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<input type="hidden" name="operDescribe" value="机构 黑白名单" /> 
