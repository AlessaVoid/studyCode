...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="理财产品分红参数信息新增" style="width:100%;height:300px;">
	   				...
	   				<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="exDividDate" value="${appDataMap.exDividDate}" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="registrationDate" value="${appDataMap.registrationDate}" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="dividendPerUnit" value="${appDataMap.dividendPerUnit}" class="validate[required],money" maxlength="12"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="DIVIDEND_STATUS" dicNo="${appDataMap.status}" id="status" name="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
									<td colspan="2">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="operDescribe" value="理财产品分红参数信息新增" /> 
						<input type="hidden" name="appNo" value="${webReviewMain.appNo }" /> 
						<input type="hidden" name="tradeCode" value="TRADE-08-01" />
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdDividendInfo/insert.htm')" class="saveButton"/>
