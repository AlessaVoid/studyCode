...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="理财产品分红参数信息修改" style="width:100%;height:300px;">
	   				...
	   				<tr>
						...
						<tr>
							...
							<td>
								${appDataMap.exDividDate}
								<input type="hidden" name="exDividDate" id="exDividDate" value="${appDataMap.exDividDate}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								${appDataMap.registrationDate}
								<input type="hidden" name="registrationDate" value="${appDataMap.registrationDate}" />
							</td>
						</tr>
						<tr>
							<td align="right">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="operDescribe" value="理财产品分红参数信息修改" /> 
