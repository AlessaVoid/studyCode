				...
				<div name="理财产品分红参数信息新增" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" name="exDividDate" class="validate[required] date" dateFmt="yyyyMMdd"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="registrationDate" class="validate[required] date" dateFmt="yyyyMMdd"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="dividendPerUnit" class="validate[required],moneyOne" maxlength="12"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="DIVIDEND_STATUS" id="status" name="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td colspan="2">
