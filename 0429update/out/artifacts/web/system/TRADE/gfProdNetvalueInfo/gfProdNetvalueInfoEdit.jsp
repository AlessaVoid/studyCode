				...
				<div name="修改产品净值" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" name="netvalue" value="${entity.netvalue}" class="validate[required] money-8" maxlength="16"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="profitRate" value="${entity.profitRate}" class="validate[required] money" maxlength="7"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="tenThousandthProfit" value="${entity.tenThousandthProfit}" class="validate[required] money" maxlength="17"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="hidden" name="countFlag" value="${entity.countFlag}" />
								<input type="text" name="latestProFitRate" value="${entity.latestProFitRate}" class="validate[required] money" maxlength="17"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
