...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="产品净值修改复核" style="width:100%;height:300px;">
	   				...
	   				<tr>
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="netvalueDate" value="${appDataMap.netvalueDate}" />
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td>
								<input type="text" name="profitRate" value="${appDataMap.profitRate}" class="validate[required],money" maxlength="7"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="tenThousandthProfit" value="${appDataMap.tenThousandthProfit}" class="validate[required],money" maxlength="17"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="latestProFitRate" value="${entity.latestProFitRate*100}" class="validate[required] money" maxlength="17"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="hidden" name="status" value="${appDataMap.status}" />
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdNetvalueInfo/update.htm')" class="saveButton"/>
