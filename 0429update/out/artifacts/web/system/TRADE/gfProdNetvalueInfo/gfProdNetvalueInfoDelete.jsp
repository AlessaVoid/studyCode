	...
	<body>
		<form id="form1">
    			<div name="删除信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="prodCode" value="${entity.prodCode}" id="prodCode"/>
						<input type="hidden" name="netvalueDate" value="${entity.netvalueDate}" id="netvalueDate"/>
						<input type="hidden" name="status" value="${entity.status}" id="status"/>
						<input type="hidden" name="operDescribe" value="净值管理" /> 
						<input type="hidden" name="tradeCode" value="TRADE-03-03" />
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdNetvalueInfo/delete.htm')" class="saveButton"/>
