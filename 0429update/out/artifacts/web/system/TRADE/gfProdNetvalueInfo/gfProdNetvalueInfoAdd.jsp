...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    function selectCurrency(val){
	  if(val.length==10){
		 $.post("<%=path%>/gfProdNetvalueInfo/selectCurrency.htm?prodCode="+val,function(result){
			if (result.success == "true" || result.success == true) {
				$("#currency").html(result.bean);
				$("#currency").render();
			}else{
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="新增产品净值" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						<tr>
							...
							<td>
								<input type="text" name="prodCode" class="validate[required,custom[noSpecialCaracters]]"  maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="netvalueDate" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="netvalue" class="validate[required] money-8" maxlength="16" value="1"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="profitRate" class="validate[required] money" maxlength="7"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="tenThousandthProfit" class="validate[required] money" maxlength="17"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="VALID_STATUS" id="status" name="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td colspan="2">
