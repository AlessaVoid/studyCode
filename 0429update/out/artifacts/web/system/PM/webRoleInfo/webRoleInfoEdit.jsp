        ...
        function sub() {
            ...
            if (valid) {
                top.Dialog.confirm("确定要保存操作吗?|操作提示", function () {
                    $.post("<%=path%>/webRoleInfo/update.htm", {
            ...
            <table class="tableStyle" width="80%" mode="list" formMode="line">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="organLevel" value="${webRoleInfoDTO.organLevel}"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        ...
                        <input type="hidden" id="roleCode" name="roleCode" value="${webRoleInfoDTO.roleCode }"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <input type="text" id="roleName" name="roleName" value="${webRoleInfoDTO.roleName }" style="width:200px"
                               class="validate[required,length[0,200],custom[chinese]"/>
