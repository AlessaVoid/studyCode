			...
			.quiGrid(
					{
						...
						url : '<%=path%>/acProfitAccConfirm/findPage.htm',
						sortName : 'tradeDate',
						rownumbers : true,
						checkbox : true,
						height : '100%',
...
function onApply() {
	if(selectOneRow(grid)){
		...
		if(costAccFlag=='0'&&profitAccFlag=='0'){
			...
			showDialog("<%=path%>/acProfitAccConfirm/apply.htm?&tradeDate=" + rows[0].tradeDate+"&prodCode="+rows[0].prodCode+"&custType=1&tradeKindCode="+rows[0].tradeKindCode,"到账确认申请信息",500,400);
			});
