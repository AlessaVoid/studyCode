	...
	<div class="basicTabModern">
		...
		<table class="tableStyle" useMultColor="true" mode="list">
			...
			<tr>
				...
				<td colspan="3"><fm:formatNumber value="${entity.cost}"	type="currency"/></td>
			</tr>
			<tr>
				<td align="right">总金额（大写）：</td>
				<td colspan="3"><fmt:formatMoneyUp fmtValue="${entity.cost}" fmtClass="width:100%;"
						id="moneyUP" /></td>
			</tr>
			<tr>
		...
		<div name="复核信息" style="width:100%;height:80px;">
			...
			<table class="tableStyle" width="97%" mode="list" formMode="line">
				...
				<tr>
					<td colspan="4">
						<div align="center">
							<button type="button" onclick="return doSubmit('form1','<%=path%>/acCostAccConfirm/doApply.htm')" class="saveButton"/>
