...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function cancel_(){
			top.Dialog.confirm("确定要退出吗?|操作提示", function() {
				top.frmright.closeCopyDialog();
				top.Dialog.close();
			});
		}
		</script>
		...
		<form id="form1">
			...
			<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line"  fixedCellHeight="true">
				...
				<tr>
					<td colspan="4">
						<div align="center">
							<button type="button" onclick="return sub('form1','<%=path%>/webResearchAppInfo/webResearchStartProcess.htm')" class="saveButton"/>
							<button type="button" onclick="return cancel_()" class="cancelButton" />	
						</div>
					</td>
				</tr>
			</table>
