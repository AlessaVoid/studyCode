			...
			.quiGrid(
					{
						...
						url : '<%=path%>/scheduleSubmited/findPage.htm',
						sortName : '',
						rownumbers : true,
						checkbox : true,
						height : '100%',
...
function onInfo() {
	if(selectOneRow(grid)){
		...
		showDialog("<%=path%>/scheduleSubmited/infoUI.htm?taskIds=" + rows[0].taskIds + "&scheduleCode=" + rows[0].scheduleCode + "&processInstanceIds="+rows[0].processInstanceIds,"档期详细信息",1280,680);
	}
}
