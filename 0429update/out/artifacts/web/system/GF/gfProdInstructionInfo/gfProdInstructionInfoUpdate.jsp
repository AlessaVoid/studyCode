	...
	<body>
		...
		<div class="basicTabModern">
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="operDescribe" value="产品说明书确认" />
						...
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<tr>
								...
								<td><select selWidth="127" 
									...
									url="<%=path%>/fdOper/getAppUserList.htm?funCode=GF-10-04">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdInstructionInfo/updateApp.htm');" class="saveButton"/>
