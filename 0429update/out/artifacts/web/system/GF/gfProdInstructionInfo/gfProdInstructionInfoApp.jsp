...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript" >
			function download(){
				...
				top.Dialog.confirm("确定要下载该说明书?",function(){
					window.location.href = "<%=path%>/gfProdInstructionInfo/download.htm?prodCode="+prodCode+"&version="+version;
				});
			}
		</script> 
	</head>
	<body>
		...
		<div class="basicTabModern">
				<div name="产品说明书确认复核" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								${appDataMap.instructionName}
								<input type="hidden" name="instructionName" id="instructionName" value="${appDataMap.instructionName}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								${appDataMap.version}
								<input type="hidden" name="version" id="version" value="${appDataMap.version}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<span onclick="download()">${appDataMap.instructionName}</span>
							</td>
						</tr>
						<tr>
							<td colspan="2">
				...
				<table class="tableStyle" width="97%" mode="list" formMode="line" fixedCellHeight="true">
					...
					<tr>
						<td colspan="4">
							<div align="center">
								<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdInstructionInfo/update.htm')" class="saveButton"/>
