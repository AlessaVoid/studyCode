...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1">
			...
			<input type="hidden" name="prodCode" id="prodCode" value="${prodName }"/>
			...
			<div id="panel1" panelTitle="产品基本参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/gfResearchContProd/prodDeignBaseInfo.htm?type=edit&prodType=2">
   				<iframe id="iframepage1" width="100%" height="100%" frameborder=0 allowTransparency="true" scrolling="auto"></iframe>
   			</div>
			<div id="panel2" panelTitle="项目分类及投资比例" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/gfResearchContProd/researchPrjInfo.htm?type=edit&selectCode=${selectCode}">
			...
			<div id="panel5" panelTitle="申报登记参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/design/registerInfo.htm?type=edit">
   			...
   			<div id="panel22" panelTitle="审批参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/gfResearchContProd/designAppUser.htm?type=edit&copyProdCode=${selectCode}">
