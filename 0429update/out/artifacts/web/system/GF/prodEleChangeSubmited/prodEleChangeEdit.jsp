...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function changeIframe(){
			...
			var isDuration = "${entity.isDuration}";
			var isOrderAutoBuy = "${entity.isOrderAutoBuy}";
			var index = '';
			if(profitHandleFlag != ""){
			...
			<tr>
				...
				<td width="15%">
					<select id="paraType">
						...
						<!-- <option value="panel2">项目基本参数</option> -->
   			...
   			<div id="panel3" panelTitle="发售区域参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/gfProdEleChange/issueAreaInfo.htm?type=edit">
   				<iframe id="iframepage3" width="100%" height="100%" frameborder=0 allowTransparency="true" scrolling="auto"></iframe>
   			</div>
   			<div id="panel4" panelTitle="发售渠道参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/gfProdEleChange/channelInfo.htm?type=edit">
