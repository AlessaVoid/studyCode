...
<form id="form1">
	...
	<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
		<tr>
			...
			<td>
				<dic:out dicType="CUST_TYPE" dicNo="2"></dic:out>
				<input type="hidden" id="custType" name="custType" value="2"/>
				<span class="star">*</span>
			</td>
		...
		<tr>
			...
			<td>
				<dic:select dicType="PROD_NAME_RULE" tgClass="validate[required]" dicNo="${entity.prodNameRule }"></dic:select>
				<span class="star">*</span>
			</td>
		...
		<tr>
			...
			<td>
			    <dic:out dicType="TR_CURRENCY" dicNo="156"></dic:out>
		...
		<tr>
			...
			<td>
				<%-- <dic:select id="isDuration" name="isDuration" dicType="IS_YES" tgClass="validate[required]" dicNo="${entity.isDuration}"></dic:select> --%>
