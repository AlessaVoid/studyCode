...
function sub(formId) {
	...
	top.Dialog.confirm('请确认维护数据来源，确认后请继续!',function() {
	//可以保存空值
	...
	$.post("<%=path%>/gfProdEleChange/compareDurationInfo.htm?openPeriod="+openPeriod+"&prodCode"+prodCode+"&modifiCreate"+modifiCreate,param,function(result) {
		...
		<form id="form1">
			...
			<input type="hidden" name="openDays" id="openDays" value = "${webProdOpenDurationRule.openDays}"/>
				...
				<tr>
					...
					<td>首次开放日:</td>
					<td>
					<input type="text" name="firstOpenDay"   id="firstOpenDay" class="date" dateFmt="yyyyMMdd" class="validate[required]" value="${webProdOpenDurationRule.firstOpenDay}"/>
					<span class="star">*</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>数据来源:</td>
					<td>
					<dic:select  dicType="MODIFI_DATA" id="modifiCreate" name="modifiCreate"></dic:select>
					<span class="star">*</span>
					</td>
				</tr>
				<tr>
