	...
	<div align="left">
   		<table class="tableStyle" width="80%" mode="list" formMode="line">
				...
				<tr>
					...
					<td>
						<input disabled="disabled"  type="text" id="statisticsDutyCycle0" name="statisticsDutyCycle" value="100" maxlength="5" class="money"/>
					</td>
				</tr>
				<tr>
					<td>按收益特征划分：</td>
					...
					<td>
						<input disabled="disabled"  type="text"  id="statisticsDutyCycle1"  name="statisticsDutyCycle" value="100" maxlength="5" class="money"/>
					</td>
				</tr>
				<tr>
					<td>按期限划分：</td>
					...
					<td>
						<input disabled="disabled"  type="text" id="statisticsDutyCycle2" name="statisticsDutyCycle" value="100" maxlength="5" class="money"/>
					</td>
				</tr>
				<tr>
					<td>按产品币种划分：</td>
					...
					<td>
						<input disabled="disabled"  type="text" id="statisticsDutyCycle3" name="statisticsDutyCycle" value="100" maxlength="5" class="money"/>
					</td>
				</tr>
				<tr>
					<td>期末理财资金投向：</td>
					...
					<td>
						<input disabled="disabled"  type="text" id="statisticsDutyCycle4" name="statisticsDutyCycle" maxlength="5" value="0" class="money gflag_1"/>
					</td>
				</tr>
			</table>
	</div>
