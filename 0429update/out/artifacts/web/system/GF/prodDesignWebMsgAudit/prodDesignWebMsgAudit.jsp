	...
	<body>
		<form id="form1">
			...
			<div id="panel5" panelTitle="申报登记参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/designAudit/registerInfoAuditUI.htm?type=audit">
   			...
   			<div id="panel21" panelTitle="业绩比较基准参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/designAudit/performanceBenchmarkInfoUI.htm?type=audit">
   				<iframe id="iframepage21" width="100%" height="80%" frameborder=0 allowTransparency="true" scrolling="auto"></iframe>
   			</div>
   			<div id="panel22" panelTitle="审批参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/designAudit/webMsgAppUser.htm?type=audit">
