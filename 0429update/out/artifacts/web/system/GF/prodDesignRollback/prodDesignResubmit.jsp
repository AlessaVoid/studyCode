...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function param(entity){
			...
			if(prodOperModel==01 || prodOperModel==03){
				$option+="<option value=\"panel20\">业绩基准参数</option>";
			}
			$option+="<option value=\"panel21\">审批参数</option>" +
					 "</select>"+
					 "</td>";
	...
	<body>
		<form id="form1">
			...
			<div id="panel5" panelTitle="申报登记参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/designRollback/registerInfo.htm?type=edit">
   			...
   			<div id="panel21" panelTitle="审批参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/designRollback/appUser.htm?type=edit">
