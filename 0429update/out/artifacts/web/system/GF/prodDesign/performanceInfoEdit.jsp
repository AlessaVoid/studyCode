...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					if (result.success == "true" || result.success == true) {
						top.Dialog.alert(result.msg,function(){
							...
							if(copyType == "copyType"){
								...
								parent.turnPage("panel21","panel22");
							}else{
	...
	<form id="form1">
		...
		<div align="center">
			<button type="button" onclick="return sub('form1','<%=path%>/design/savePerformanceBenchmark.htm')" class="saveButton"/>
		</div>
   	</form>
	</body>
</html>