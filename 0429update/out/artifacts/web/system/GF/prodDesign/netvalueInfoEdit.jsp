...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					if (result.success == "true" || result.success == true) {
						top.Dialog.alert(result.msg, function() {
							if(copyType == "copyType"){
								if(isPoint =="1"){
									parent.turnPage("panel13","panel14");
								}else{
									if(isCustProp=="1"){
										parent.turnPage("panel13","panel15");
									}else{
										if(prodOperModel == "03" || prodOperModel == "04"){
											parent.turnPage("panel13","panel16");
										}else{
											parent.turnPage("panel13","panel17");
										}
									}
								}
							}else{
	...
	<form id="form1">
   	...
   	<div align="center">
		<button type="button" onclick="return sub('form1','<%=path%>/design/saveNetvalueInfo.htm')" class="saveButton"/>
