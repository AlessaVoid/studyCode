...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	scaleProfitGrid = $("#scaleProfitParam").quiGrid({
           columns: [
                   ...
                   { display: '客户类型', name: 'custType', align: 'center', width: "16%",type: 'CUSTTYPE',
                   ...
                   { display: '启用状态', name: 'status', align: 'center', width: "16%",type: 'STARTFLAG',
	...
	<body onclick="fmtText()">
		<form id="form1">
			...
			<input type="hidden" name="oldIndex" id="oldIndex" value="${oldIndex }"/>
   			...
   			<div align="center">
				<button type="button" onclick="return sub('form1','<%=path%>/design/saveScaleProfitRateInfo.htm')" class="saveButton"/>
			</div>
	   	</form>
	</body>
</html>