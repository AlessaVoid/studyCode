		...
		<div class="basicTabModern">
				<div name="TA份额解冻结" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								${appDataMap.applicationcode}
								<input type="hidden" name="applicationcode" value="${appDataMap.applicationcode}" class="validate[required]" maxlength="20"/>
							</td>
						</tr>
						<tr>
							<td align="right">
    			...
    			<div name="复核信息" style="width:100%;height:240px;">
					...
					<tr>
						<td colspan="4">
							<div align="center">
								<button type="button" onclick="return doSubmit('form1','<%=path%>/taShareUnFreeze/doApproval.htm')" class="saveButton"/>
