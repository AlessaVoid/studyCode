...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="销售商新增信息" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
	   					<tr>
							...
							<td>
								<input type="text" name="retailerCode"  class="validate[required]" maxlength="10" onkeyup="value=value.replace(/[^\w\.\-/]/ig,'')"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="retailerName"  class="validate[required]" maxlength="30"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="retailerAllName" class="validate[required]" maxlength="50"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="retailerEnName"  class="validate[required],custom[onlyLetter]" maxlength="100"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="retailer_type" id="retailerType" name="retailerType" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="fax" class="validate[required]"  maxlength="20"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="contactPersonName" class="validate[required]" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="contactPersonTell" class="validate[required]" maxlength="20"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td>
								<input type="text" name="contactAddress" class="validate[required]" maxlength="100"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="RETAILER_STATUS" id="status" name="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
									<td colspan="2">
