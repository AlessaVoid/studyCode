...
$(function(){
	...
	$("#freezeCode").bind("blur",function(){
		if ($("#freezeCode").val().length>0) {
			$.post("<%=path%>/taAcctUnFreezeDTO/getFreezeInfo.htm", 
					{"freezeCode" : $("#freezeCode").val()}, function(result) {
						if (result.customerkind==null) {
				...
				<div name="TA账户解冻结" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" id="certificatecode" onblur="isCardNo($('#certificatekind').val(),this.value);" name="certificatecode" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td>
								<textarea id="freezeReason" name="freezeReason" rows="5" cols="10"readonly="readonly"></textarea>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td>
								<input type="text" name="unfreezeHandleName" class="validate[required]" maxlength="60"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<dic:select dicType="D_CUST_CERT_TYPE" id="unfreezeHandleCertType" name="unfreezeHandleCertType" tgClass="validate[required]"></dic:select>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="unfreezeHandleCertCode" onblur="isCardNo($('#unfreezeHandleCertType').val(),this.value);" class="validate[required,length[0,20]]" maxlength="20"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
