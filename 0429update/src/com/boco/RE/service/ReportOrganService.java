 ...
 * 机构区域重点行表service
 */
public interface ReportOrganService {
     ...
     * @return
     */
    List<ProductReport> getReportData(String combType, String date, String cycel, FdOrgan fdorgan, String dimension) throws Exception;
