 ...
 * </pre>
 */
public class TbCalculateOneProportionHistory extends BaseEntity implements java.io.Serializable {
	...
	/** 使用参数的月份 */
		@EntityParaAnno(zhName="使用参数的月份")
	private String month;
	/** 类型：1-月度，2-年度 */
	@EntityParaAnno(zhName="类型：1-月度，2-年度")
