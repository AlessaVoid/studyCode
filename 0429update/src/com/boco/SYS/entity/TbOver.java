 ...
 * </pre>
 */
public class TbOver extends BaseEntity implements java.io.Serializable {
    ...
    /** organname */
    @EntityParaAnno(zhName="organname")
     ...
     * 调整额度/临时额度
     */
    public void setQaAmt(String qaAmt) {
        this.qaAmt = qaAmt == null ? null : qaAmt.trim();
    }

    public String getQaAmt() {
        return this.qaAmt;
    }
