 ...
 * </pre>
 */
public interface TbSingleMapper extends GenericMapper<TbSingle, Integer>{
     ...
     */
    void updateQuotaApplyByQaIdAndOrganCode(TbSingle tbLineTemp);
     ...
     * </pre>
     */
    List<Map<String, Integer>> selectQaId(TbSingle tbLineTemp);
     ...
     * </pre>
     */
    List<Map<String, String>> selectQaMonth(TbSingle tbLineTemp);
