 ...
 * </pre>
 */
public interface TbOverMapper extends GenericMapper<TbOver, Integer>{
     ...
     */
    void updateQuotaApplyByQaIdAndOrganCode(TbOver tbLineTemp);
     ...
     * </pre>
     */
    List<Map<String, Integer>> selectQaId(TbOver tbLineTemp);
     ...
     * </pre>
     */
    List<Map<String, String>> selectQaMonth(TbOver tbLineTemp);
