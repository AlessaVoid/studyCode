...
public class TbPunishAppovedController extends BaseController {
    ...
    @SystemLog(tradeName = "已审批罚息结果申请", funCode = "AL", funName = "已审批罚息结果申请列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已审批罚息结果申请", funCode = "AL", funName = "已审批罚息结果申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
