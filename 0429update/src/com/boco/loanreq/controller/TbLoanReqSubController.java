...
public class TbLoanReqSubController extends BaseController {
    ...
    @SystemLog(tradeName = "已提交信贷需求", funCode = "PUB-01-05", funName = "已提交信贷需求列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已提交信贷需求", funCode = "PUB-01-05", funName = "已提交信贷需求", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-01-05-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
