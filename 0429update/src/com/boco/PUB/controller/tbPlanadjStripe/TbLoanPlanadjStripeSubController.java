...
public class TbLoanPlanadjStripeSubController extends BaseController {
    ...
    @SystemLog(tradeName = "已提交条线计划", funCode = "PUB-03-06", funName = "已提交条线计划列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已提交条线计划", funCode = "PUB-03-06", funName = "已提交条线计划", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
