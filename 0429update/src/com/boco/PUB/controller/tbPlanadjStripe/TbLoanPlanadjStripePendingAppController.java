...
public class TbLoanPlanadjStripePendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的条线计划调整列表页面", funCode = "PUB-06-03", funName = "待审批的条线计划调整列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "待审批的条线计划调整列表", funCode = "PUB-06-03", funName = "待审批的条线计划调整列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "条线计划调整审批详情页面", funCode = "PUB-06-03-03", funName = "条线计划调整审批详情页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "条线计划调整审批", funCode = "PUB-06-03", funName = "审批条线计划调整", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String auditLoanReqRequest(String comment, String planadjId, String taskId, String assignee, String isAgree, String lastUserType) throws Exception {
        try {
            ...
            e.printStackTrace();
            return this.json.returnMsg("fasle", "调整后额度不能为负").toJson();
        }
    }
