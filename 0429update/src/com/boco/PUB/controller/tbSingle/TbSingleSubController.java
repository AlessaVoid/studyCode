...
/**
 * @ClassName TbSingleSubController
 ...
 **/
@Controller
@RequestMapping("/singleApplySub")
public class TbSingleSubController extends BaseController {
    ...
    @SystemLog(tradeName = "已提交条线临时额度申请", funCode = "PUB-12-03", funName = "已提交条线临时额度申请列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String loanSubmitAuditHistoryRecordUI() throws Exception {
        authButtons();
        return basePath + "/PUB/tbSingle/submitted/tbQuotaApplySubmitIndexList";
    }

    @ResponseBody
    @RequestMapping("/getSubmitAuditHistoryRecord")
    @SystemLog(tradeName = "已提交条线临时额度申请", funCode = "PUB-12-03", funName = "已提交条线临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String getSubmitAuditHistoryRecord(String auditStatus, String qaMonth) throws Exception {
        setPageParam();
        WebOperInfo sessionOperInfo = getSessionOperInfo();
        setPageParam();
        List<Map<String, Object>> list = tbSingleService.getAuditRecordHistRecord(sessionOperInfo.getOperCode(), auditStatus,
                qaMonth);
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-12-03-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqSubmitDetailAuditUI(int qaId, String processInstanceId) throws Exception {
        ...
        return basePath + "/PUB/tbSingle/submitted/tbQuotaApplySubmitDetailPage";
    }
