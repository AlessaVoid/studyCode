...
public class TbSingleRejectController extends BaseController {
    ...
    @SystemLog(tradeName = "驳回的条线临时额度申请列表", funCode = "PUB-12-06", funName = "驳回的条线临时额度申请列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-12-06-01", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "重新提交条线临时额度申请", funCode = "PUB-12-06-01", funName = "重新提交条线临时额度申请页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "单一条线临时额度", funCode = "PUB-12-06", funName = "审批条线临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "修改条线临时额度申请", funCode = "PUB-12-06-01", funName = "修改条线临时额度申请", accessType = Dic.AccessType.WRITE, level = Dic.Debug.INFO)
    public @ResponseBody
