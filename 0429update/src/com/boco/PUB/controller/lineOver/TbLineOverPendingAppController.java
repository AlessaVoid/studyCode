...
public class TbLineOverPendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的条线临时额度申请", funCode = "PUB-14-04", funName = "待审批的条线临时额度申请列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "单一条线临时额度", funCode = "PUB-14-04", funName = "条线临时额度申请任务审批详情页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "获取条线临时额度申请审批人员", funCode = "PUB-14", funName = "获取条线临时额度申请审批人员", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "单一条线临时额度", funCode = "PUB-14-04", funName = "审批条线临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String auditLoanQuotaApplyRequest(String comment, String qaId, String taskId, String assignee, String isAgree, String lastUserType, String tbOverDetail) throws Exception {
        ...
        return this.json.returnMsg("true", "提交条线超限额申请成功!").toJson();
    }
    ...
    @SystemLog(tradeName = "修改条线临时额度申请", funCode = "PUB-14-04", funName = "修改条线临时额度申请", accessType = Dic.AccessType.WRITE, level = Dic.Debug.INFO)
    public @ResponseBody
