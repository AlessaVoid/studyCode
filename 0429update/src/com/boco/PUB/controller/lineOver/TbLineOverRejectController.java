...
/**
 * @ClassName TbLineOverRejectController
...
@Controller
@RequestMapping(value = "/lineOverApplyReject")
public class TbLineOverRejectController extends BaseController {
    @Autowired
    ...
    @SystemLog(tradeName = "驳回的条线临时额度申请列表", funCode = "PUB-14-06", funName = "驳回的条线临时额度申请列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String loanAllRejectPlanListUI() throws Exception {
        authButtons();
        return basePath + "/PUB/lineOverManage/rejected/rollBackAuditList";
    }
    ...
    public String listAllRollBackTaskList(String qaMonth, Pager pager) throws Exception {
        setPageParam();
        List<Map<String, Object>> list = tbOverService.getPendingAppReq("0",  getSessionOperInfo().getOperCode(), qaMonth, TbLineOver.STATE_DISMISSED + "", pager);
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-14-06-01", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqSubmitDetailAuditUI(int qaId, String processInstanceId) throws Exception {
        ...
        return basePath + "/PUB/lineOverManage/rejected/rejectDetailPage";
    }
    ...
    @SystemLog(tradeName = "重新提交条线临时额度申请", funCode = "PUB-14-06-01", funName = "重新提交条线临时额度申请页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqDetailAuditUI(int qaid, String taskid) throws Exception {
        ...
        setAttribute("fileName", fileName);
        return basePath + "/PUB/lineOverManage/rejected/rejectCommitPage";
    }
    ...
    @SystemLog(tradeName = "单一条线临时额度", funCode = "PUB-14-06", funName = "审批条线临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String auditLoanReqRequest(HttpServletRequest request,String comment, String qaId, String taskId, String assignee, String isAgree, String lastUserType) throws Exception {
        ...
        msgMap.put("taskId", taskId);//当前正在执行的任务ida
        ...
        return this.json.returnMsg("true", "重新提交条线超限额申请成功!").toJson();
    }
    ...
    @SystemLog(tradeName = "修改条线临时额度申请", funCode = "PUB-14-06-01", funName = "修改条线临时额度申请", accessType = Dic.AccessType.WRITE, level = Dic.Debug.INFO)
    public @ResponseBody
