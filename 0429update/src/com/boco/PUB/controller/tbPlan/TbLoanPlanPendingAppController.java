...
public class TbLoanPlanPendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的信贷计划列表页面", funCode = "PUB-03-07", funName = "待审批的信贷计划列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "待审批的信贷计划列表数据", funCode = "PUB-03-07", funName = "待审批的信贷计划列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "信贷计划任务审批页面", funCode = "PUB-03-07-02", funName = "信贷计划任务审批页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "信贷计划审批", funCode = "PUB-03-07-01", funName = "审批信贷计划", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-03-07-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
