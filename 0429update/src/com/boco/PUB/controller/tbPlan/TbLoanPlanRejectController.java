...
public class TbLoanPlanRejectController extends BaseController {
    ...
    @SystemLog(tradeName = "驳回的信贷计划列表", funCode = "PUB-03-09", funName = "驳回的信贷计划列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "驳回的信贷计划列表数据", funCode = "PUB-03-09", funName = "驳回的信贷计划列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "重新提交信贷计划页面", funCode = "PUB-03-09-01", funName = "重新提交信贷计划页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "信贷计划审批", funCode = "PUB-03-09-01", funName = "审批信贷计划", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-03-09-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
