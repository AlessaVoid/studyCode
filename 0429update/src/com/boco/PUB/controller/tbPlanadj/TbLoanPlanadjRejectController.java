...
public class TbLoanPlanadjRejectController extends BaseController {
    ...
    @SystemLog(tradeName = "驳回的信贷计划调整列表", funCode = "PUB-06-05", funName = "驳回的信贷计划调整列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "重新提交信贷计划调整", funCode = "PUB-06-05-01", funName = "重新提交信贷计划调整页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "信贷计划调整审批", funCode = "PUB-06-05", funName = "信贷计划调整审批", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
