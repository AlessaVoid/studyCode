...
public class TbLoanPlanStripeSubController extends BaseController {
    ...
    @SystemLog(tradeName = "已提交条线计划列表", funCode = "PUB-07-02", funName = "已提交条线计划列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已提交条线计划列表数据", funCode = "PUB-07-02", funName = "已提交条线计划列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-07-02-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "导出计划", funCode = "PUB-07", funName = "导出计划", accessType = Dic.AccessType.READ, level = Dic.Debug.INFO)
