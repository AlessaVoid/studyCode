...
/**
 * @Author: liujinbo
 * @Description: 信贷计划 待审批记录
 * @Date: 2019/11/18
 * @Version: 1.0
 */
@Controller
@RequestMapping("/tbPlanStripePendingApp")
public class TbLoanPlanStripePendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的条线计划列表页面", funCode = "PUB-07-03", funName = "待审批的条线计划列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listUI() throws Exception {
        authButtons();
        return basePath + "/PUB/tbPlanStripe/tbPlanPendingApp/loanPlanPendingAppIndexList";
    }

    @ResponseBody
    @RequestMapping("/getPendingAppTbPlan")
    @SystemLog(tradeName = "待审批的条线计划列表数据", funCode = "PUB-07-03", funName = "待审批的条线计划列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String getPendingAppReq(HttpServletRequest request, HttpServletResponse response,Pager pager) throws Exception {
        ...
        try{
            ...
            data = tbPlanService.getPendingPlanStripe(sort,sessionOperInfo.getOperCode(), planMonth, auditStatus, pager, TbPlan.STRIPE);
    ...
    @SystemLog(tradeName = "条线计划任务审批页面", funCode = "PUB-07-03-02", funName = "条线计划任务审批页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqDetailAuditUI(String planId, String taskid) throws Exception {
        ...
        return basePath + "/PUB/tbPlanStripe/tbPlanPendingApp/tbPlanDetailAuditPage";
    ...
    @SystemLog(tradeName = "条线计划审批", funCode = "PUB-07-03-01", funName = "审批条线计划", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-07-03-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqSubmitDetailAuditUI(String planId, String processInstanceId) throws Exception {
        ...
        return basePath + "/PUB/tbPlanStripe/tbPlanPendingApp/tbPlanPendingDetailPage";
    }
