...
public class TbLoanPlanStripeApprovedController extends BaseController {
    ...
    @SystemLog(tradeName = "已审批条线计划列表页", funCode = "PUB-07-04", funName = "已审批条线计划列表页", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已审批条线计划列表页数据", funCode = "PUB-07-04", funName = "已审批条线计划列表页数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-07-04-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
