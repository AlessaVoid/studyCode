...
/**
 * @Author: liujinbo
 * @Description: 季度评分已驳回的记录
 * @Date: 2020/02/05
 * @Version: 1.0
 */
@Controller
@RequestMapping("/tbOrganRateScoreQuarterReject")
public class TbOrganRateScoreQuarterRejectController extends BaseController {
    ...
    @SystemLog(tradeName = "驳回的季度评分列表", funCode = "AL-04-05", funName = "驳回的季度评分列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String loanAllRejectPlanListUI() throws Exception {
        authButtons();
        return basePath + "/AL/tbOrganRateScoreQuarter/tbOrganRateScoreQuarterReject/tbOrganRateScoreQuarterRejectIndexList";
    }

    @ResponseBody
    @RequestMapping("/listAllRollBackTaskList")
    @SystemLog(tradeName = "驳回的季度评分列表数据", funCode = "AL-04-05", funName = "驳回的季度评分列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listAllRollBackTaskList(HttpServletRequest request,String rateMonth, Pager pager) throws Exception {
        ...
        try {
            ...
            list = tbOrganRateScoreService.getPendingAppReq(sort, sessionOperInfo.getOperCode(), rateMonth,auditStatus, pager, OrganRateParamElementType.RATE_QUARTER);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @SystemLog(tradeName = "重新提交季度评分页面", funCode = "AL-04-05-01", funName = "重新提交季度评分页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqDetailAuditUI(String id,String taskid) throws Exception {
        ...
        return basePath + "/AL/tbOrganRateScoreQuarter/tbOrganRateScoreQuarterReject/tbOrganRateScoreQuarterDetailRejectAuditPage";

    }

    @ResponseBody
    @RequestMapping(value = "/auditRateScoreRequest", method = RequestMethod.POST)
    @SystemLog(tradeName = "季度评分审批", funCode = "AL-04-05-01", funName = "审批季度评分", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "AL-04-05-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqSubmitDetailAuditUI(String id,String processInstanceId) throws Exception {
        ...
        return basePath + "/AL/tbOrganRateScoreQuarter/tbOrganRateScoreQuarterReject/tbOrganRateScoreQuarterRejectDetailPage";
    }
