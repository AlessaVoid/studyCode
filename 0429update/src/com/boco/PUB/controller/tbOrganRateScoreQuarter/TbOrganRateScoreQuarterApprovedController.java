...
public class TbOrganRateScoreQuarterApprovedController extends BaseController {
    ...
    @SystemLog(tradeName = "已审批季度评分列表页", funCode = "AL-03-04", funName = "已审批季度评分列表页", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已审批季度评分列表页数据", funCode = "AL-03-04", funName = "已审批季度评分列表页数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "AL-04-04-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
