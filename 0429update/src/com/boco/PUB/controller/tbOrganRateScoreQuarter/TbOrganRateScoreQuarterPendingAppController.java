...
public class TbOrganRateScoreQuarterPendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的季度评分列表页面", funCode = "AL-04-03", funName = "待审批的季度评分列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "待审批的季度评分列表数据", funCode = "AL-04-03", funName = "待审批的季度评分列表数据", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "季度评分任务审批页面", funCode = "AL-04-03-01", funName = "季度评分任务审批页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "季度评分审批", funCode = "AL-04-03-01", funName = "审批季度评分", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
