 ...
 **/
@Controller
@RequestMapping("/TbLineReqResetApproved")
public class TbLineReqResetApprovedController extends BaseController {
    @Autowired
    ...
    @SystemLog(tradeName = "已审批信贷需求", funCode = "PUB-10", funName = "已审批信贷需求列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String loanApprovedAuditHistoryRecordUI() throws Exception {
        authButtons();
        return basePath + "/PUB/tbLineReqResetManage/approvd/loanReqApprovedIndexList";
    }

    @ResponseBody
    @RequestMapping("/getApprovedAuditHistoryRecord")
    @SystemLog(tradeName = "已审批信贷需求", funCode = "PUB2", funName = "已审批信贷需求", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String getApprovedAuditHistoryRecord(String auditStatus, String lineReqMonth) throws Exception {
        ...
        List<Map<String, Object>> list = lineReqResetAppService.getApprovedRecord(sessionOperInfo, auditStatus);
    ...
    public String listReqSubmitDetailAuditUI(int lineReqresetId, String processInstanceId) throws Exception {
        ...
        return basePath + "/PUB/tbLineReqResetManage/approvd/loanReqApprovedDetailPage";
    }
