...
public class TbLineReqResetPendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的信贷需求", funCode = "PUB-10", funName = "待审批的信贷需求列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "机构需求", funCode = "PUB-10-01", funName = "信贷需求任务审批详情页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "获取需求审批人员", funCode = "PUB-10", funName = "获取需求审批人员", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "机构需求", funCode = "PUB-10-01", funName = "审批信贷需求", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "修改信贷需求", funCode = "PUB-10-01", funName = "修改信贷需求", accessType = Dic.AccessType.WRITE, level = Dic.Debug.INFO)
    public @ResponseBody
