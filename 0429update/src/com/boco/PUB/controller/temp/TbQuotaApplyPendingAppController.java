...
public class TbQuotaApplyPendingAppController extends BaseController {
    ...
    @SystemLog(tradeName = "待审批的临时额度申请", funCode = "PUB-04-04", funName = "待审批的临时额度申请列表页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "单一机构临时额度", funCode = "PUB-04-04", funName = "临时额度申请任务审批详情页面", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "获取临时额度申请审批人员", funCode = "PUB-04", funName = "获取临时额度申请审批人员", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "单一机构临时额度", funCode = "PUB-04-04", funName = "审批临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "修改临时额度申请", funCode = "PUB-04-04", funName = "修改临时额度申请", accessType = Dic.AccessType.WRITE, level = Dic.Debug.INFO)
    public @ResponseBody
