...
public class TbLineTempAppovedConteoller extends BaseController {
    ...
    @SystemLog(tradeName = "已审批条线临时额度申请", funCode = "PUB-11-05", funName = "已审批条线临时额度申请列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "已审批条线临时额度申请", funCode = "PUB-11-05", funName = "已审批条线临时额度申请", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-11-05-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
