...
/**
 * @ClassName approvrdController
 * @Description 已审批的信贷需求调整调整申请
 * @Author tangxn
 * @Date 20191122 上午10:23
 * @Version 2.0
 **/
@Controller
@RequestMapping(value = "/TbReqresetApproved/")
public class approvrdController extends BaseController {
    @Autowired
    ...
    @SystemLog(tradeName = "已审批信贷需求调整", funCode = "PUB-05-05", funName = "已审批信贷需求调整列表", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String loanApprovedAuditHistoryRecordUI() throws Exception {
        authButtons();
        return basePath + "/PUB/tbReqResetManage/approved/reqresetApprovedIndexList";
    }

    @ResponseBody
    @RequestMapping("/getApprovedAuditHistoryRecord")
    @SystemLog(tradeName = "已审批信贷需求调整", funCode = "PUB-05-05", funName = "已审批信贷需求调整", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String getApprovedAuditHistoryRecord(String auditStatus, String reqresetMonth) throws Exception {
        setPageParam();
        ...
        setPageParam();
        List<Map<String, Object>> list = loanReqResetService.getApprovedRecord(sessionOperInfo, auditStatus);
    ...
    @SystemLog(tradeName = "查看审批详情", funCode = "PUB-05-05-02", funName = "查看审批详情", accessType = Dic.AccessType.READ, level = Dic.Debug.DEBUG)
    public String listReqSubmitDetailAuditUI(int reqresetId, String processInstanceId) throws Exception {
        ...
        return basePath + "/PUB/tbReqResetManage/approved/reqresetApprovedDetailPage";
    }
