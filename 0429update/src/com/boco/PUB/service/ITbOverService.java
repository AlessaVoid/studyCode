 ...
 * </pre>
 */
public interface ITbOverService extends IGenericService<TbOver, Integer>{
     ...
     **/
    List<Map<String,Object>> getPendingAppReq(String type, String operCode, String reqMonth, String auditStatus, Pager pager,String organCode) throws Exception;
