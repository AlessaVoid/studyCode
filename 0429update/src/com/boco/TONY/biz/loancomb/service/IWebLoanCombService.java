 ...
 * @date 2019-09-17
 */
public interface IWebLoanCombService {
    /**
     * 通过贷种组合级别查询贷种组合信息
     */
     ...
     * 通过贷种组合级别查询贷种组合信息
     */
    ListResult<LoanCombDTO> getLoanCombInfoByLevel2(int combLevel);

    /**
     * 查询所有贷种组合信息列表
     */
    List<LoanCombDTOV2> getAllLoanCombInfo2(String combCode, String combName, String combLevel);

    /**
     * 查询所有贷种组合信息
     */
    List<LoanCombDTOV2> getAllLoanCombInfo();
     ...
     * @return
     */
    List<LoanCombDO> getCombCodeList(int combLevel);
    /**
     * 查询所有贷种组合信息列表
     */
     ...
     * 通过贷种组合编码查询贷种组合信息
     */
    PlainResult<LoanCombDTO> getLoanCombInfoByCombCode(String combCode);
     ...
     */
    ListResult<LoanCombDTO> getLoanCombInfoByName(String name);
