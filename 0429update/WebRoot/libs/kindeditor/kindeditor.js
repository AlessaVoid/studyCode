...
K.options = {
	...
	fullscreenMode : false,//true时加载编辑器后变成全屏模式
	filterMode : true,//true时过滤HTML代码，false时允许输入任何代码
	wellFormatMode : true,//true时美化HTML数据
	shadowMode : true,//true时弹出层(dialog)显示阴影
	basePath : K.basePath,//指定编辑器的根目录路径
	themesPath : K.basePath + 'themes/',//指定编辑器的themes目录路径
	langPath : K.basePath + 'lang/',//指定编辑器的lang目录路径
	pluginsPath : K.basePath + 'plugins/',//指定编辑器的plugins目录路径
	themeType : 'default',//指定主题风格，可设置”default”、”simple”，指定simple时需要引入simple.css
	langType : 'zh_CN',//指定语言，可设置”en”、”zh_CN”，需要引入lang/[langType].js
	...
	syncType : 'form',//同步数据的方式，可设置”“、”form”，值为form时提交form时自动同步，空时不会自动同步
	pasteType : 2,//设置粘贴类型，0:禁止粘贴, 1:纯文本粘贴, 2:HTML粘贴
	dialogAlignType : 'page',//设置弹出框(dialog)的对齐类型，可设置”“、”page”，指定page时按当前页面居中，指定空时按编辑器居中
	useContextmenu : true,//true时使用右键菜单，false时屏蔽右键菜单
	fullscreenShortcut : false,//
	bodyClass : 'ke-content',//指定编辑器iframe document body的className
	indentChar : '\t',//wellFormatMode 为true时，HTML代码缩进字符
	cssPath : '',//指定编辑器iframe document的CSS文件，用于设置可视化区域的样式
	cssData : '',//指定编辑器iframe document的CSS数据，用于设置可视化区域的样式
	minWidth : 650,//指定编辑器最小宽度，单位为px
	minHeight : 100,//指定编辑器最小高度，单位为px
	minChangeSize : 50,//undo/redo文字输入最小变化长度，当输入的文字变化小于这个长度时不会添加到undo记录里
	zIndex : 811213,
	items : [
		 'selectall','fullscreen','undo', 'redo', '|',
		 'preview', 'print', 'cut', 'copy', 'paste','plainpaste','wordpaste','template','|', 
		 'justifyleft', 'justifycenter', 'justifyright','justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'clearhtml','|',
		 'formatblock', 'fontname', 'fontsize', '|', 
		 'forecolor', 'hilitecolor', 'bold','italic', 'underline', 'strikethrough', 'lineheight'
	],//配置编辑器的工具栏，其中”/”表示换行，”|”表示分隔符
	/*noDisableItems : [ 'undo', 'redo', 'preview', 'print', 'cut', 'copy', 'paste',
	          		'plainpaste',  'justifyleft', 'justifycenter', 'justifyright',
	        		'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'selectall', 
	        		 'formatblock', 'fontname', 'fontsize',  'forecolor', 'hilitecolor', 'bold',
	        		'italic', 'underline', 'strikethrough', 'lineheight','fullscreen'],//designMode为false时，要保留的工具栏图标
*/	colorTable : [
