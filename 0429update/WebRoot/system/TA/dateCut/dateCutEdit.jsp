...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="修改日切时间" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						<tr>
							...
							<td>
							${entity.dateCutDate}
								<input type="hidden" name="dateCutDate" value="${entity.dateCutDate}" />
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" class="date validate[required]" dateFmt="HHmmss" name="dateCutTime" value="${entity.dateCutTime}" />
						...
						<tr>
							...
							${entity.updateTimeStamp}
								<input type="hidden" name="updateTimeStamp" value="${entity.updateTimeStamp}" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
