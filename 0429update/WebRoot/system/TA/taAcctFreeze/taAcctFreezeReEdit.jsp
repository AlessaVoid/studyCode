				...
				<div name="TA账户冻结" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
	   					<tr>
							...
							<td>
								<dic:select id="customerkind"  name="customerkind" dicNo="${appDataMap.customerkind}" dicType="D_CUST_TYPE" tgClass="validate[required]"></dic:select>
						...
						<tr>
							...
							<td>
								<div id="custDiv">
									<dic:select id="cust" onChange="changeCertType(this.value)" dicNo="${appDataMap.certificatekind}" dicType="D_CUST_CERT_TYPE" tgClass="validate[required]"></dic:select>
								</div>
								<div id="corpDiv">
									<dic:select id="corp" onChange="changeCertType(this.value)" dicNo="${appDataMap.certificatekind}" dicType="D_CORP_CERT_TYPE" tgClass="validate[required]"></dic:select>
								</div>
						...
						<tr>
							...
							<td>
								<input type="text" name="certificatecode" value="${appDataMap.certificatecode}" onblur="isCardNo($('#certificatekind').val(),this.value);" class="validate[required,length[0,30]]" maxlength="30"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="customername" value="${appDataMap.customername}"  class="validate[required],length[0,100]" maxlength="100"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<textarea rows="5" cols="10" name="freezeReason">${appDataMap.freezeReason}</textarea>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="autoUnfreezeDate" value="${appDataMap.autoUnfreezeDate}" dateFmt="yyyyMMdd" class="date validate[length[0,8]]"  maxlength="8"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="freezeJudicialFileCode" value="${appDataMap.freezeJudicialFileCode}" class="validate[required]"  maxlength="50"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="handleName" value="${appDataMap.handleName}" class="validate[required]" maxlength="50"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<dic:select dicType="D_CUST_CERT_TYPE" dicNo="${appDataMap.handleCertType}" name="handleCertType" tgClass="validate[required]"></dic:select>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="handleCertCode" onblur="isCardNo($('#handleCertType').val(),this.value);" 
									value="${appDataMap.handleCertCode}" class="validate[required,length[0,20],custom[noSpecialCaracters]]" maxlength="20"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
