				...
				<div name="TA份额解冻结" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" id="customerkind" name="customerkind" value="${appDataMap.customerkind}" readonly="readonly"/>
						...
						<tr>
							...
							<td>
								<input type="text" name="applicationcode" value="${appDataMap.applicationcode}" class="validate[required]" maxlength="20"/>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td>
								<input type="text" id="unfreezehandlejudicialcode" name="unfreezehandlejudicialcode" value="${appDataMap.unfreezehandlejudicialcode}" class="validate[required]" />
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="unhandlename" value="${appDataMap.unhandlename}" class="validate[required]" maxlength="60"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<dic:select dicType="D_CUST_CERT_TYPE" value="${appDataMap.unhandlecerttype}" id="unhandlecerttype" name="unhandlecerttype" tgClass="validate[required]"></dic:select>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="unhandlecertcode" value="${appDataMap.unhandlecertcode}" onblur="isCardNo($('#unfreezeHandleCertType').val(),this.value);" class="validate[required,length[0,20],custom[onlyNumber]]" maxlength="20"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
    			...
    			<div name="复核申请" style="width:100%;">
					...
					<table class="tableStyle" width="97%" mode="list" formMode="line">
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/taAcctFreeze/approval.htm')" class="saveButton"/>
