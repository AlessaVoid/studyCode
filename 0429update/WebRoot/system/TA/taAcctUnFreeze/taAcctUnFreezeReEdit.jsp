				...
				<div name="TA账户解冻结" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
	   					<tr>
							...
							<td>
								<input type="text" name="freezeCode" value="${appDataMap.freezeCode}" onchange="changeFreezeCode();"/>
						...
						<tr>
							...
							<td>
							    <dic:select disabled="disabled"  id="customerkind"  name="customerkind" dicNo="${appDataMap.customerkind}" dicType="D_CUST_TYPE" tgClass="validate[required]" readonly="readonly"></dic:select>
						...
						<tr>
							...
							<td>
								<div id="custDiv">
									<dic:select disabled="disabled" id="cust" name="certificatekind" dicNo="${appDataMap.certificatekind}" dicType="D_CUST_CERT_TYPE" tgClass="validate[required]"></dic:select>
								</div>
								<div id="corpDiv">
									<dic:select disabled="disabled" id="corp" name="certificatekind" dicNo="${appDataMap.certificatekind}" dicType="D_CORP_CERT_TYPE" tgClass="validate[required]"></dic:select>
								</div>
						...
						<tr>
							...
							<td>
								<input type="text" id="certificatecode" name="certificatecode" value="${appDataMap.certificatecode}" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" id="customername" name="customername" value="${appDataMap.customername}" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" id="freezeReason" name="freezeReason" value="${appDataMap.freezeReason}" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="unfreezeHandleJudicialCode" value="${appDataMap.unfreezeHandleJudicialCode}" class="validate[required]"  maxlength="50"/>
							    <span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="unfreezeHandleName" value="${appDataMap.unfreezeHandleName}" class="validate[required]" maxlength="60"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<dic:select dicType="D_CUST_CERT_TYPE" dicNo="${appDataMap.unfreezeHandleCertType}" id="unfreezeHandleCertType" name="unfreezeHandleCertType" tgClass="validate[required]"></dic:select>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="unfreezeHandleCertCode" value="${appDataMap.unfreezeHandleCertCode}" onblur="isCardNo($('#unfreezeHandleCertType').val(),this.value);" class="validate[required,length[0,20],custom[noSpecialCaracters]]" maxlength="20"/>
								<span id="star" class="star">*</span>
							</td>
						</tr>
						<tr>
					...
					<table class="tableStyle" width="97%" mode="list" formMode="line">
						...
						<tr>
							...
							<td><select selWidth="127" 
								...
								url="<%=path%>/fdOper/getAppUserList.htm?funCode=TA-04-01">
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/taAcctUnFreezeDTO/approvalUnFreeze.htm')" class="saveButton"/>
