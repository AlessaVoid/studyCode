...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="设置机构白名单" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								<input type="text" name="organCode" class="validate[required],custom[noSpecialCaracters]" maxlength="8"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="USE_STATUS" name="status" id="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td colspan="2">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<input type="hidden" name="tradeCode" value="TRADE-04-01" />
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdOrganWhiteList/insert.htm')" class="saveButton"/>
