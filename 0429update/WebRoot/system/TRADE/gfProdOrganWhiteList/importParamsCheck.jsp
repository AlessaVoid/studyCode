		...
		<div class="basicTabModern">
				...
				<c:forEach items="${requestScope.appDataMap.list}" var="index">
						<input type="hidden" name="xmlData"
							value="${index.prodCode}|${index.organCode}|${index.listType}|${index.status}|${index.latestModifyDate}|${index.latestModifyTime}|${index.latestOperCode}|${index.organLevel}|" />
				</c:forEach>
						<tr>
							<td colspan="2">
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdOrganWhiteList/importDialog.htm')" class="saveButton"/>
