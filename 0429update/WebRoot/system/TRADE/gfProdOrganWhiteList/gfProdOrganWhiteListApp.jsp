...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="机构黑白名单复核" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								${appDataMap.organCode}
								<input type="hidden" name="organCode" value="${appDataMap.organCode}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="hidden" value="${appDataMap.status}" name="status"/>
    			...
    			<input type="hidden" name="organLevel" value="${appDataMap.organLevel}"/>
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdOrganWhiteList/doApproval.htm')" class="saveButton"/>
