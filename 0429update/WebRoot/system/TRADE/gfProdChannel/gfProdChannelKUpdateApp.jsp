...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="渠道开启复核" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
								...
								<dic:out dicType="D_MENU_STATUS" dicNo="${appDataMap.status}" ></dic:out>
							</td>
						</tr>
						<tr>
							<td colspan="2">
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdChannel/kupdateApproval.htm')" class="saveButton"/>
