...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1">
    			<div name="开通信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="prodCode" value="${entity.prodCode}" id="prodCode"/>
						<input type="hidden" name="channelCode" value="${entity.channelCode}" id="channelCode"/>
						<input type="hidden" name="tradeCode" value="${entity.tradeCode}" id="tradeCode"/>
						<input type="hidden" name="operDescribe" value="暂停交易参数开通" /> 
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdTradeCtl/delete.htm')" class="saveButton"/>
