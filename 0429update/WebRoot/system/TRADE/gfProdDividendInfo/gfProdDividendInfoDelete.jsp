		...
		<form id="form1">
    			<div name="删除信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<input type="hidden" name="exDividDate" value="${entity.exDividDate}" id="exDividDate"/>
						<input type="hidden" name="operDescribe" value="理财产品分红参数信息" /> 
						<input type="hidden" name="tradeCode" value="TRADE-08-03" />
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdDividendInfo/delete.htm')" class="saveButton"/>
