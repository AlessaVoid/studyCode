...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="理财产品分红参数信息复核" style="width:100%;height:300px;">
	   				<table class="tableStyle" width="80%" mode="list" formMode="line">
						...
						<tr>
							...
							<td>
							    ...
							    <input type="hidden" name="registrationDate" id="registrationDate" value="${appDataMap.registrationDate}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								${appDataMap.dividendPerUnit}
								<input type="hidden" name="dividendPerUnit" id="dividendPerUnit" value="${appDataMap.dividendPerUnit}"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								...
								<dic:out dicType="DIVIDEND_STATUS" dicNo="${appDataMap.status}" ></dic:out>
							</td>
						</tr>
						<tr>
							<td colspan="2">
				...
				<tr>
						...
						<tr>
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdDividendInfo/doApproval.htm')" class="saveButton"/>
