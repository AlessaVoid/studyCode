...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="导入客户黑白名单" style="width:100%;height:300px;">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						...
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdCustWhiteList/importParams.htm')" class="saveButton"/>
