...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="basicTabModern">
				<div name="产品净值新增复核" style="width:100%;height:300px;">
	   				...
	   				<tr>
							...
							<td>
								<input type="text" name="prodCode" value="${appDataMap.prodCode}" class="validate[required]" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="netvalueDate" value="${appDataMap.netvalueDate}" class="validate[required] date" dateFmt="yyyyMMdd" maxlength="10"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="netvalue" value="${appDataMap.netvalue}" class="validate[required],money" maxlength="16"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="profitRate" id="profitRate" value="${appDataMap.profitRate}" class="validate[required],money"/>%
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" name="tenThousandthProfit" id="tenThousandthProfit" value="${appDataMap.tenThousandthProfit}" class="validate[required],money"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<dic:select dicType="VALID_STATUS" dicNo="${appDataMap.status}" id="status" name="status" tgClass="validate[required]"></dic:select><span class="star">*</span>
							</td>
						</tr>
						<tr>
									<td colspan="2">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					<div style="width: 98%">
						<input type="hidden" name="operDescribe" value="新增净值产品" /> 
						...
						<table class="tableStyle" width="97%" mode="list" formMode="line">
							...
							<td colspan="4">
								<div align="center">
									<button type="button" onclick="return doSubmit('form1','<%=path%>/gfProdNetvalueInfo/insert.htm')" class="saveButton"/>
