...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function initComplete(){
		...
		netvalueGrid = $("#performanceParam").quiGrid({
	           columns: [
	           { display: '显示日期', name: 'performanceDate', align: 'center', width: "33%",
	           },
	           { display: '业绩比较基准（%）', name: 'performanceValue', align: 'center', width: "33%",
	...
	<form id="form1">
		...
		<div align="center">
		   <table class="tableStyle"  mode="list" formMode="line" style="width: 97%;">
		      <tr>
		       <td>是否挂钩标的：</td>
		       <td>
				 <dic:out  dicType="IS_YES" dicNo="${entity.isPeg}"></dic:out>
				</td>
				<td>挂钩描述：</td>
				<td>
		...
		<%-- <div align="center">
			<button type="button" onclick="return sub('form1','<%=path%>/webResearchAppInfo/savePerformanceBenchmark.htm')" class="saveButton"/>
		</div> --%>
   	</form>
	</body>
</html>