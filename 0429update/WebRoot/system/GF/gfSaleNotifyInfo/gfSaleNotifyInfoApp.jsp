		   	...
		   	function doAppSubmit(){
		   		...
		   		if (valid) {
		   			top.Dialog.confirm("确定要保存操作吗?|操作提示", function() {
		   				...
		   				param.push(map);
		   				$.post("<%=path%>/gfSaleNotifyInfo/doNotifyApp.htm", param, function(result) {
		...
		<div class="basicTabModern">
    			...
    			<div name="复核信息" style="width:100%;height:80px;">
					...
					<form id="form1">
						...
						<input type="hidden" id="notifyCode" name="notifyCode" value="${appDataMap.notifyCode}"/>
