...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function prodImport(){
			...
			dialog.Title = "模板导入";
			dialog.URL = "<%=path%>/system/GF/webResearch/ImportDialog.jsp",
			dialog.Width = 500;
			dialog.Height = 260;
			dialog.show();
		}
		...
		function copy(){
			dialog = new top.Dialog();
			dialog.Title = "复制新增页面";
			dialog.URL = "<%=path%>/system/GF/webResearchCopy/webResearchCopy.jsp";
			dialog.Width = 500;
			dialog.Height = 260;
			dialog.show();
		}
		...
		//关闭复制新增页面
		function closeProdImportDialog(){
			dialog.close();
		}
		</script>
	</head>
	<body >
		<form id="form1">
			...
			<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
				<tr>
					<td align="right" width="16%">复制新增：</td>
					<td width="16%">
						<button type="button" onclick="return copy();">复制新增</button>
					</td>
					<td align="right" width="16%">参数模板： </td>
					<td width="16%">
						<button type="button" onclick="return prodImport();">导入</button>
					</td>	
			...
			<div id="panel1" panelTitle="产品预研基本参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/webResearchAppInfo/baseInfo.htm?type=edit">
				<iframe id="iframepage1" width="100%" height="80%" frameborder=0 allowTransparency="true" scrolling="auto"></iframe>
   			</div>
			<div id="panel2" panelTitle="项目分类及投资比例" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/webResearchAppInfo/prjInfo.htm?type=edit">
			...
			<div id="panel5" panelTitle="申报登记参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/webResearchAppInfo/registerInfo.htm?type=edit">
   			...
   			<div id="panel13" panelTitle="审批参数" class="box2_custom" boxType="box2" startState="close" panelUrl="<%=path%>/webResearchAppInfo/appUser.htm?type=edit">
