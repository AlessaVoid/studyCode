...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	fixPeriodProfitGrid = $("#fixPeriodProfitParam").quiGrid({
           columns: [
           { display: '存续周期(天)', name: 'durationPeriod', align: 'center', width: "20%",
...
function sub(formId,url) {
	...
	<body>
		...
		<div align="center">
			<button type="button" onclick="return sub('form1','<%=path%>/webResearchAppInfo/insertFixPeriodProfitRat.htm')" class="saveButton"/>
		</div>
	   	</form>
	</body>
</html>