			...
			<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
				...
				<tr>
					...
					<td width="15%">
						<c:choose>
							<c:when test="${empty entity.currency}">
								<dic:select name="currency" id="currency" dicType="TR_CURRENCY" dicNo="156" onchange="openIsProfitFeeToRmb();" tgClass="validate[required]"></dic:select>
							</c:when>
							<c:otherwise>
								<dic:select name="currency" id="currency" dicType="TR_CURRENCY" dicNo="${entity.currency}" onchange="openIsProfitFeeToRmb();" tgClass="validate[required]"></dic:select>
							</c:otherwise>
						</c:choose>
						<span class="star">*</span>
					</td>
