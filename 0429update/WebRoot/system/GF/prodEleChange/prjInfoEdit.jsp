...
function appendPrjInfoDialog(){
    ...
    diag.OKEvent = function(){
		...
		var prodCode = $("#prodCode").val();
       	$.post("<%=path%>/gfProdEleChange/findGfPrjInfo.htm?requestType=saveButton&prodCode="+prodCode, param, function(result) {
			if (result.success == "true" || result.success == true) {
	...
	<body>
		<form id="form1" action="">
		   ...
		   <table class="tableStyle"  mode="list" formMode="line" style="width: 100%;">
			...
			<div align="center">
				<button type="button" onclick="return sub('form1','<%=path%>/gfProdEleChange/comparePrjProInfo.htm')" class="saveButton"/>
			</div>
	   	</form>
	</body>
</html>