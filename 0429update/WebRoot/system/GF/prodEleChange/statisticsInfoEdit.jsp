...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
			...
			<script>
function sub() {
		//将disabled的输入项去掉 非空验证
		$("form :disabled").removeClass("validate[required]");
		...
		if (valid) {
			top.Dialog.confirm("是否保存该条信息?", function() {
				...
				rallmoney();
				buttonluck();
				$.post("<%=path%>/gfProdEleChange/compareStatisticsInfo.htm",$("#form1").serialize(),
				function(result) {
					buttonUnluck();
	...
	<div align="left">
  		<table class="tableStyle" width="80%" mode="list" formMode="line">
			...
			<tr>
				...
				<td>
					<input type="text" id="statisticsDutyCycle0" name="statisticsDutyCycle" value="100" maxlength="7" class="money"/>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text"  id="statisticsDutyCycle1"  name="statisticsDutyCycle" value="100" maxlength="7" class="money"/>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="statisticsDutyCycle2" name="statisticsDutyCycle" value="100" maxlength="7" class="money"/>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="statisticsDutyCycle3" name="statisticsDutyCycle" value="100" maxlength="7" class="money"/>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="statisticsDutyCycle4" name="statisticsDutyCycle" maxlength="7" value="0" class="money gflag_1"/>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
