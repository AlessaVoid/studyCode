...
<form id="form1">
	...
	<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
		...
		<tr>
			...
			<td>
				<c:choose>
					...
					<c:otherwise>
						<dic:select name="accountingFlag" id="accountingFlag" dicType="ACCOUNTING_FLAG" onChange="changeDisabled();" dicNo="${entity.accountingFlag}" tgClass="validate[required]"></dic:select>
					</c:otherwise>
				</c:choose>
				<span class="star">*</span>
			</td>
		...
		<tr>
			...
			<td>
				<dic:select id="isDuration" name="isDuration" dicType="IS_YES" dicNo="${entity.isDuration}"></dic:select>
				<span class="star">*</span>
			</td>
			<td align="right">
				定投业务开办标志：
		...
		<tr>
			...
			<td>计息基础：</td>
		 	<td>
				<dic:select name="dayCountBasis" dicType="DAYCOUNTBASIS" tgClass="validate[required]" dicNo="${entity.dayCountBasis}"></dic:select>
				<span class="star">*</span>
			</td>
			<td align="right">
				一次性费用：
		...
		<tr>
			<td colspan="8">
				<div align="center">
					<button type="button" onclick="return sub('form1','<%=path%>/designStartProcess/updateBaseInfo.htm')" class="saveButton"/>
				</div>
			</td>
		</tr>
	</table>
