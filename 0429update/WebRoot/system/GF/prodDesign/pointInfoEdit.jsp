						...
						if (result.success == "true" || result.success == true) {
							top.Dialog.alert(result.msg, function() {
								if(copyType == "copyType"){
									if(isCustProp=="1"){
										parent.turnPage("panel14","panel15");
									}else{
										if(prodOperModel == "03" || prodOperModel == "04"){
											parent.turnPage("panel14","panel16");
										}else{
											parent.turnPage("panel14","panel17");
										}
									}
								}else{
	...
	<form id="form1">
		...
		<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
			...
			<tr>
				<td colspan="4">
					<div align="center">
						<button type="button" onclick="return sub('form1','<%=path%>/design/savePointInfo.htm')" class="saveButton"/>
					</div>
				</td>
			</tr>
		</table>
