					...
					top.Dialog.alert(result.msg, function() {
						if(copyType == "copyType"){
							if(prodOperModel == "01" || prodOperModel == "03"){
								...
								if(isPoint=="1"){
									parent.turnPage("panel12","panel14");
								}else{
									if(isCustProp=="1"){
										parent.turnPage("panel12","panel15");
									}else{
										if(prodOperModel == "04"){
											parent.turnPage("panel12","panel16");
										}else{
											parent.turnPage("panel12","panel17");
										}
									}
								}
							}
...
function skip(){
	...
	<body onclick="fmtText();">
		...
		<div align="center">
			<button type="button" onclick="return sub('form1','<%=path%>/design/saveDevidentInfo.htm')" class="saveButton"/>
