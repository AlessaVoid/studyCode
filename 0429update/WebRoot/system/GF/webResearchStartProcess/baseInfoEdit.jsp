		...
		<form id="form1">
			...
			<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line">
				...
				<tr>
					...
					<td width="15%">
						<dic:select fn="onChange='deleteProfit(this.value);'" id="profitHandleFlag" name="profitHandleFlag" dicNo="${entity.profitHandleFlag}" dicType="PROFIT_FLAG" tgClass="validate[required]"></dic:select>
						<span class="star">*</span>
					</td>
				...
				<tr>
					<td colspan="4">
						<div align="center" >
							<button type="button" onclick="return sub('form1','<%=path%>/webResearchStartProcess/updateBaseInfo.htm')" class="saveButton"/>
						</div>
					</td>
				</tr>
			</table>
