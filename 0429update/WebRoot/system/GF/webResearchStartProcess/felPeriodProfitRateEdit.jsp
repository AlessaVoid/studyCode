...
<script type="text/javascript">
	...
	felPeriodProfitGrid = $("#felPeriodProfitParam").quiGrid({
           ...
           { display: '启用状态', name: 'status', align: 'center', width: "12%",type: 'STARTFLAG',
        	   render : function(rowdata) {
        		   if (rowdata.status == "1") {
        				return "有效";
...
function sub(formId,url) {
	...
	<body onclick="fmtText()">
		...
		<div align="center">
			<button type="button" onclick="return sub('form1','<%=path%>/webResearchStartProcess/updateFelPeriodProfitRate.htm')" class="saveButton"/>
		</div>
	   	</form>
	</body>
</html>