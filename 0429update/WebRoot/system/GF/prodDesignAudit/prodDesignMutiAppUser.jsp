	...
	<head>
		...
		function sub(formId,url){
			...
			if (valid) {
				...
				var map = {};
				map.name = "gridData";
				map.value= JSON.stringify(top.document.getElementById("_DialogFrame_mutiAppDesign").contentWindow.getGridData());
				param.push(map);
				map = {};
				map.name = "isAgree";
				map.value = "1";
		...
		<form id="form1">
			...
			<table class="tableStyle tab-hei-30" width="80%" mode="list" formMode="line"  fixedCellHeight="true">
				...
				<tr>
					<td colspan="4">
						<div align="center">
							<button type="button" onclick="return sub('form1','<%=path%>/designAudit/mutiAudit.htm')" class="saveButton"/>
