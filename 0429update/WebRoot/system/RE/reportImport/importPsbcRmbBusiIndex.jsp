...
<script>
    ...
    function initTable() {
        grid = $("#dataBasic").quiGrid({
            ...
            url: '<%=path%>/reportHisImport/getPsbcRmbBusiData.htm',
            rownumbers: true,
            height: '100%',
            width: "100%",
            pageSize: 10,
    ...
    function onUpload(){
        ...
        var $divSub =    $('<div style="margin-bottom:10px;font-weight: 600;">请选择上传文件：<span style="font-size:12px;color:gray">  (支持文件类型：xls、xlsx,暂不支持et格式)</span></div>');
    ...
    function onUploadFile(file, dialog, $dialogDiv, $divTip, $divForm, $divDate){
        ...
        if(fileName){
            ...
            $.ajax({
                ...
                data:{type:1, statisticsDay:statisticsDay},
                dataType: "json",
    ...
    //下载模板
    function onDown(){
        openDownloadDialog('<%=path%>/libs/excel/temp/TempPsbcRmbBusi.xlsx', '银行业人民币主要业务分地区统计表（资金运用）.xlsx');
    }
