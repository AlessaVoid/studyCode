...
<script>
    ...
    var bankNameMap = ${bankNameMap}; //银行简称Map
    var grid;
    function initTable() {
        grid = $("#dataBasic").quiGrid({
            ...
            url: '<%=path%>/reportHisImport/getBankRmbBusiData.htm',
            rownumbers: true,
            height: '100%',
            width: "100%",
            pageSize: 10,
    ...
    function onUploadFile(file, dialog, $dialogDiv, $divTip, $divForm, $divDate){
        ...
        if(fileName){
            ...
            $.ajax({
                ...
                data:{type:2, statisticsDay:statisticsDay},
                dataType: "json",
    ...
    //下载模板
    function onDown(){
        openDownloadDialog('<%=path%>/libs/excel/temp/TempBankRmbBusi.xlsx', '主要商业银行人民币业务统计表（资金运用）.xlsx');
    }
