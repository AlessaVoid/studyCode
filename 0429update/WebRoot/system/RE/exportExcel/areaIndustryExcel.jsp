...
<div class="box2_custom" boxType="box2" panelTitle="数据列表" class="padding_right5">
    <div align="center" ><h3  style="display: inline;">地区表&nbsp;&nbsp;</h3></div>
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/report/areaIndustryExcel.htm',
                    sortName: '',
                    // rownumbers: true,
    ...
    function onDownload() {
        ...
        location = "<%=path%>/report/downloadAreaIndustryExcel.htm?date=" + date + "&cycel=" + cycel + "&unit=" + unit;
    }
