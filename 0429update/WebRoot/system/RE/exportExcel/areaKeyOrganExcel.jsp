...
<div class="box2_custom" boxType="box2" panelTitle="数据列表" class="padding_right5">
    <div align="center" ><h3  style="display: inline;">区域重点行表&nbsp;&nbsp;</h3> </div>
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/report/organExcel.htm',
                    sortName: '',
                    // rownumbers: true,
    ...
    function onDownload() {
        ...
        location = "<%=path%>/report/downloadOrganExcel.htm?date=" + date + "&cycel=" + cycel + "&combType=" + combType
