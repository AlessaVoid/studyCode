...
//机构级别下拉框
	var organLevel={"list":[{"value":"0","key":"总行"},{"value":"1","key":"一级分行"},{"value":"2","key":"二级分行"}]};
//客户类型下拉框
...
taskRoleInfoGrid = $("#taskRoleInfoParam").quiGrid({
       ...
       { display: '角色代码', name: 'roleCode', align: 'center', width: "20%",
    	   editor:{type:'select',url:'${path}/workflow/getTaskRole.htm',selWidth:150,boxWidth:250}
       },
	...
	if (valid) {
		...
		<form id="form1">
			...
			<div id="taskRoleInfoParam" class="padding_right5"></div>
   			<div align="center">
				<button type="button" onclick="return sub('form1','<%=path%>/webTaskRoleInfo/updateTaskRoleInfo.htm')" class="saveButton"/>
			</div>
	   	</form>
	</body>
</html>