...
<head>
    ...
    <script type="text/javascript">
        ...
        //     var c={};c.log=c.warn=c.debug=c.info=c.center=c.time=c.dir=c.profile=c.clear=c.exception=c.trace=c.assert=function () {};
        //     return c;
        // })();
        ...
        function initLoanCombSelectedNodes() {
            ...
            var combUrl = "<%=path%>/webLoan/listLoanCombByLevel.htm?combLevel=";
        ...
        function sub() {
            ...
            if (valid) {
                ...
                $.post("<%=path%>/webLoan/updateLoanCombInfo.htm", {
 ...
 if(menu_id==undefined){
        ...
        function checkLoanCombInfo(combCode, combName) {
            ...
            var checkUrl = "<%=path%>/webLoan/checkCombInfo.htm";
            var isExist = false;
            $.ajax({
                    type: 'POST',
                    url: checkUrl,
