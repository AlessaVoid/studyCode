...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/singleApplyPendingApp/getPendingAppTbSingle.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/singleApplyPendingApp/tbQuotaApplyAuditUI.htm?qaid=" + rows[0].qaid + "&taskid=" + rows[0].taskid , "审批单一机构单笔专项申请", 1280, 680);
        } else {
