        ...
        <table class="tableStyle" mode="list" formMode="line" style="width: 100%;">
            <tr>
                ...
                <td width="20">
                    ...
                    <input name="lineReqMonth" type="text" id="sys_time" class="input-small inline form_datetime"
                           style="width: 160px;"/>
...
<script type="text/javascript">
            ...
            .quiGrid(
                {
                    ...
                    url: '<%=path%>/tbTradeManger/tbLineReqDetail/showFindPage.htm',
                    sortName: '',
                    rownumbers: true,
                    checkbox: true,
                    height: '100%',
    ...
    function onSubmit() {
        if (selectOneRow(grid)) {
            ...
            if (rows[0].lineState >= 4) {
                ...
                showDialog("<%=path%>/TbLineReqApp/commitTbReqUI.htm?lineReqId=" + rows[0].lineReqId, "信贷需求提交页面", 800, 600);
            }
        }
    }
    ...
    function onInsert() {
        if (selectOneRow(grid)) {
            ...
            if (rows[0].lineState == 1) {
                showDialog("<%=path%>/tbTradeManger/tbLineReqDetail/insertUI.htm?lineReqId=" + rows[0].lineReqId, "录入信息", 1080, 680);
            } else {
    ...
    function onUpdate() {
        if (selectOneRow(grid)) {
            ...
            if (rows[0].lineState == 2) {
                showDialog("<%=path%>/tbTradeManger/tbLineReqDetail/updateUI.htm?lineReqId=" + rows[0].lineReqId,
                    "修改信息", 1080, 680);
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/tbTradeManger/tbLineReqDetail/infoUI.htm?lineReqId=" + rows[0].lineReqId,
                "详细信息", 900, 680);
        }
    }
</script>
