...
<script type="text/javascript">
    ...
    function sub(testNum) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=path%>/tbTradeManger/tbLineReqDetail/insert.htm",
            data: {"lineUnit": lineUnit, "tbLineReqDetail": tbLineReqDetail,"lineReqId":lineReqId,"state":2,"lineRefId":lineRefId,"testNum":testNum},
            dataType: "json",
 ...
 if(menu_id==undefined){
                    ...
                    if (result.code == '403') {
                        ...
                        top.Dialog.alert("当前批次的条线需求已录入，请转至菜单查看", function () {
                            var menu_id = parent.getCurrentTabId();
                            if (menu_id == undefined) {
                                top.Dialog.close();
                                return;
    ...
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        <tr>
            ...
            <td>
                ...
                <input id="lineReqMonth" name="lineReqMonth" type="hidden" value="${TbLineReqDetail.lineReqMonth}"> </input>
