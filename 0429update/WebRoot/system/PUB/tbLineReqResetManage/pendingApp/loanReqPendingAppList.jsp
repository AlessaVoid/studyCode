...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbLineReqResetPendingApp/getPendingAppReq.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/TbLineReqResetPendingApp/listReqDetailAuditUI.htm?linereqresetid=" + rows[0].linereqresetid + "&taskid=" + rows[0].taskid, "审批信贷需求", 1280, 680);
        } else {
