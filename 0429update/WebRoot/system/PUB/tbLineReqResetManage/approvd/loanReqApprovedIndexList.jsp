...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbLineReqResetApproved/getApprovedAuditHistoryRecord.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onInfo() {
        if (selectOneRow(grid)) {
            ...
            showDialog("<%=path%>/TbLineReqResetApproved/listReqApprovedDetailAuditUI.htm?lineReqresetId=" + rows[0].linereqresetid + "&processInstanceId=" + rows[0].procinstid, "信贷详细信息", 1280, 680);
        }
    }
