...
<script type="text/javascript">
        ...
        grid = $("#dataBasic").quiGrid(
            {
                ...
                url: '<%=path%>/TbLoanReqPendingApp/getPendingAppReq.htm',
                sortName: '',
                rownumbers: true,
                checkbox: true,
                height: '100%',
    ...
    function onAudit() {
        ...
        if (rows.length === 1) {
            showDialog("<%=path%>/TbLoanReqPendingApp/listReqDetailAuditUI.htm?reqid=" + rows[0].reqid + "&taskid=" + rows[0].taskid, "审批信贷需求", 1280, 680);
        } else {
