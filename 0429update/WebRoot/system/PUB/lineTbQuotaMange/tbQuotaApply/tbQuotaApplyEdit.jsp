...
<script type="text/javascript">
    ...
    function submitInfo() {
        ...
        $.ajax({
            url: '<%=path%>/tbTradeManger/lineTbQuotaApply/update.htm',
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
 ...
 if(menu_id==undefined){
    ...
    function initComplete() {
        ...
        $("#qaComb").setValue("${TbLineTemp.qaComb}");
    }
    ...
    <table class="tableStyle" id="table1" width="80%" mode="list" formMode="line">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="qaAmt" name="qaAmt" onblur='upperCase(this)'
                        value="${TbLineTemp.qaAmt}"  class=" validate[required,custom[onlyNumberWide]] float_left"
        ...
        <tr >
            ...
            <td>
                ...
                <input type="text" id="qaStartDate" name="qaStartDate" class="validate[required] date" value="${TbLineTemp.qaStartDate}" AUTOCOMPLETE="off"
            ...
            <td>
                ...
                <input type="text" id="qaExpDate" name="qaExpDate" class="validate[required] date" value="${TbLineTemp.qaExpDate}" AUTOCOMPLETE="off"
                       dateFmt="yyyyMMdd"  onfocus="WdatePicker({skin:themeColor,minDate:'%y-%M-%d',maxDate:maxDateStr})"/>
                <span class="star">*</span>
            </td>
        ...
        <tr>
            ...
            <td>
                <dic:select id="unit" dicType="CURRENCY_UNIT" name="unit" dicNo="${TbLineTemp.unit}"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea id="qaReason" name="qaReason" AUTOCOMPLETE="off"   style="width:90%;" class="validate[required]">${TbLineTemp.qaReason} </textarea>
            </td>
        </tr>
    </table>
