    ...
    <script type="text/javascript">
        ...
        function xhrSubmit() {
            ...
            top.Dialog.confirm("确定要导入文件吗?|操作提示", function() {
                ...
                $.ajax({
                    url: '<%=path%>/tbCalculateTwoResult/enterReport.htm',
                    type: 'POST',
                    data: fd,
 ...
 if(menu_id==undefined){
        ...
        function calculateOneMonth() {
            top.Dialog.confirm("确定要生成测算模式一的结果吗？", function () {
                $.post("<%=path%>/tbCalculateTwoResult/addTbCalculateTwoResult.htm", null, function (result) {
        ...
        function download() {
            openDownloadDialog('<%=path%>/libs/excel/tbCalculateTwo/TbCalculateTwo.xls', '测算模式二历史数据导入表样.xls');
        }
