...
<form id="form1">
    ...
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="adjCountThree1" name="adjCountThree1" class="rateParam"
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="adjCountTwo1" name="adjCountTwo1" class="rateParam"
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="scaleThree1" name="scaleThree1" class="rateParam"
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="scaleTwo1" name="scaleTwo1" class="rateParam"
