...
<form id="form1">
    ...
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        ...
        <tr>
            ...
            <td>
                <select name="directScore1" size="1" id="directScore1" >
                    <option value="1"  ${tbOrganRateParamList[0].directScore==1?'selected':''}>A</option>
                    <option value="2"  ${tbOrganRateParamList[0].directScore==2?'selected':''}>B</option>
                    <option value="3"  ${tbOrganRateParamList[0].directScore==3?'selected':''}>C</option>
                    <option value="4"  ${tbOrganRateParamList[0].directScore==4?'selected':''}>D</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="directScore2" size="1" id="directScore2" >
                    <option value="1"  ${tbOrganRateParamList[1].directScore==1?'selected':''}>A</option>
                    <option value="2"  ${tbOrganRateParamList[1].directScore==2?'selected':''}>B</option>
                    <option value="3"  ${tbOrganRateParamList[1].directScore==3?'selected':''}>C</option>
                    <option value="4"  ${tbOrganRateParamList[1].directScore==4?'selected':''}>D</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="directScore3" size="1" id="directScore3" >
                    <option value="1"  ${tbOrganRateParamList[2].directScore==1?'selected':''}>A</option>
                    <option value="2"  ${tbOrganRateParamList[2].directScore==2?'selected':''}>B</option>
                    <option value="3"  ${tbOrganRateParamList[2].directScore==3?'selected':''}>C</option>
                    <option value="4"  ${tbOrganRateParamList[2].directScore==4?'selected':''}>D</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="directScore4" size="1" id="directScore4" >
                    <option value="1"  ${tbOrganRateParamList[3].directScore==1?'selected':''}>A</option>
                    <option value="2"  ${tbOrganRateParamList[3].directScore==2?'selected':''}>B</option>
                    <option value="3"  ${tbOrganRateParamList[3].directScore==3?'selected':''}>C</option>
                    <option value="4"  ${tbOrganRateParamList[3].directScore==4?'selected':''}>D</option>
                </select>
            </td>
        </tr>
