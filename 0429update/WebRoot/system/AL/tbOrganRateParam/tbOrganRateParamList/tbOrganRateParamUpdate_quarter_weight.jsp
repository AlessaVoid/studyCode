...
<form id="form1">
    ...
    <table class="tableStyle" width="80%" mode="list" formMode="line">
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="scoreOne1" name="scoreOne1" class="rateParam"
                       value="${tbOrganRateParamList[0].scoreOne}" maxlength="20"
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="scoreTwo1" name="scoreTwo1" class="rateParam"
                       value="${tbOrganRateParamList[0].scoreTwo}" maxlength="20"
                       oninput='upperCase(this)' />
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input type="text" id="scoreThree1" name="scoreThree1" class="rateParam"
                       value="${tbOrganRateParamList[0].scoreThree}" maxlength="20"
                       oninput='upperCase(this)' />
            </td>
    ...
    function submitInfo() {
        ...
        for (var i = 1; i < paramCount; i++) {
            ...
            var map = {
                ...
                "scoreOne": $('#scoreOne'+ i).val(),
                "scoreTwo": $('#scoreTwo'+ i).val(),
                "scoreThree": $('#scoreThree'+ i).val()
