...
<form id="form1" >
	...
	<div name="复核信息" style="width:100%;height:240px;">
				...
				<input type="hidden" name="currency"  value="${appDataMap.currency}"/>
				<table class="tableStyle" width="97%" mode="list" formMode="line" fixedCellHeight="true">
					...
					<tr>
						<td colspan="4">
							<div align="center">
								<button type="button" onclick="return doSubmit('form1','<%=path%>/taHkNotifyInfoF/doApproval.htm')" class="saveButton"/>
